...
class Cell(Base):
    ...
    def __init__(self, exec_id, session_id, code, output=None, modified_files=None):
    ...
    def __repr__(self):
        return "Cell(%s, session_id=%s, code='%s', output='%s', modified_files='%s')"%(
            self.exec_id, self.session_id, self.code, self.output, self.modified_files)
