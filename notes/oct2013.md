# NEXT RELEASE
  ...
  [ ] run some update-alternatives to fix java -- https://mail.google.com/mail/u/0/?shva=1#inbox/142012b67d1a8c3f

# TODAY:

  - [ ] move a project by hand.  Here's how:
...
- [ ] opening an image -- need a close button in responsive mobile mode.

- [x] inital document undo -- I just opened a document and found "Loading..." in the undo buffer.  NOT COOL.

- [ ] snapshot servers -- they are *still* stopping periodically and requiring a restart, even after I fixed some obvious issues that would cause this.  WHY?
