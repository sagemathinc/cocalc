[ ] next release:
   - [ ] apt-get install  fig2ps epstool cpulimit
...
- [ ] button to move project if compute vm appears to be not working
...
- [ ] project: add link to open sharing page
- [ ] show project last mod date
