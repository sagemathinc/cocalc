...
- Current projects:
    ...
    - better containment through LXC, with project rebalancing.

# Super high priority

- [ ] increase capacity of cluster by adding cloud5-7, cloud10-21!

  x - update hosts so cloud10-21 hostnames just work...

    - tmux profile so I can parallel ssh to specific cloud[n]'s...

    - add every cloud[n] to the vpn as 10.1.n.1.
...
- [ ] it seems like the green spinner when computing in a worksheet... is just gone?  It's not working for me.  I have no idea how this broke, but this should confuse the hell out of everyone!   FIX THIS for next release for sure. 
