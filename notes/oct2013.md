...
# Goal: Rewrite cassandra schema and queries to not do *any* queries that use secondary indexes, then switch to QUORUM consistency for ops.  Make sure all queries work without allow filtering.
