...
--> - [ ] upgrade to new font awesome 4.0 -- is css spinner fast?

- [ ] when autosaving don't strip trailing whitespace from any line with any other cursor


- [ ] better terminal cursor: https://mail.google.com/mail/u/0/?shva=1#inbox/141bda5712492477

- [ ] detecting when compute machines are down/up and setting entry in the `compute_server` database...  two hours work and we get high availability.
