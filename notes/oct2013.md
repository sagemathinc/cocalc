- [ ] new release
     - [ ] upgrade to sage-5.12
     - [ ] upgrade to ipython-1.1
...
## The two common big queries, and both are slow because the use a secondary index or filtering.  These are the only two that do this.
  ...
  - [ ] `email_address --> account_id`
        ...
        --> - [ ] make a function that generates this table straight through called: "update_?"
        - [ ] test on cloud and see how fast ;-)
        - [ ] make code so that when creating an account an entry is added.
