...
--> - [ ] user quota info: use zfs part of status info to update this quota stuff for UI: 'Files and snapshots: 424MB (or 11%) this project's quota of 3.9GB (3.5GB are left)
