...
coffee> x={};s.storage_db((e,d)->x.d=d)
coffee> p='001ad862-bf23-4758-be4b-3a1ab1076e2a'; c0=x.d.chunked_storage(p); c0.verbose=true; c0.sync(path:"/home/salvus/streams/#{p}",cb:(e)->console.log('done',e))    
