...
> - [ ] move compute7a - I'm tired of having to worry about disk space there.  In progress in a tmux session.  ETA: 10am-ish

>  - [ ] try switching to daily build of ZFS for ubuntu: https://launchpad.net/~zfs-native/+archive/daily
...
> - [ ] update base vm: new kernel.

 - [ ] write a img --> zvol convertor script.

 - [ ] implement zvol recompaction
 ...
 - [ ] stress test, as before.

   Observation 1: Damn -- zfs is *incredibly* easy to deadlock.  Scary easy.


 - [ ] if works, reduce chunk size to 4mb, and write a convertor

 - [ ] start running convertor, and get back to business.

- [ ] (1:00?) what if reboot machine so not open, but database thinks open..  Need a refresh or something?

- [ ] (1:00?) rsync of the .sagemathcloud template
