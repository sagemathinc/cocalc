...
> - [ ] (0:20?) move compute7a - I'm tired of having to worry about disk space there.  In progress in a tmux session.  ETA: 10am-ish

 - [ ] update base vm: new kernel.

 - [ ] (1:00?) write a img --> zvol convertor script.

 - [x] (0:45?) implement zvol re-compaction
 ...
 - [ ] (1:30?) stress test, as before.

   Observation 1: Damn -- zfs is *incredibly* easy to deadlock.  Scary easy.
                  But... it works fine with only one thread.

- [ ] reduce chunk size to 4mb

- [ ] (1:30?) start running convertor, and get back to business.
...
- [ ] create new vm's for migrated projects to live on, to avoid any zfs deadlock issues.
