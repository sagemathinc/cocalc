# Issues to remember
  ...
  - [ ] whenever a save+sync happens successful, store the last sync time in database
  ...
  - [ ] when first starting a project its state keeps switching to stopped then starting then running - and also the start command gets executed 5 times... or so NOT GOOD
