...
>> - [ ] delete existing database
 ...
 - [ ] migrate the db nodes at google from ZFS to ext4 and reboot them to be sure; switch to 512GB/machine -- add more machines when I need more space, or just shutdown, rsync, etc. 

 - [ ] create new schema

 - [ ] sync the bup repos into new db, but excluding/deleting the objects/tmp* files

 - [ ] rewrite `storage_server` to use bup.

 - [ ] make hub work with new system

 - [ ] code to update project bup

 - [ ] code to switch over project

 - [ ] migrate older snapshots after switch-over
