...
>> - [ ] test forever changes and server starting
...
status=[];require('storage').migrate3_all(retry_errors:true,limit:20,max_age_h:3*24,status:status,cb:(e)->console.log("DONE",e))
          ...
          { status: 'failed',
            project_id: '14362ece-fa0c-43e3-bd42-2d3b5e50af3e',
            project_host: '10.1.21.4',
            error: 'earlier action \'import_pool\' failed -- recv_streams(project_id=14362ece-fa0c-43e3-bd42-2d3b5e50af3e,{}): \nsudo /sbin/zpool list projects-14362ece-fa0c-43e3-bd42-2d3b5e50af3e\n[\'sudo\', \'zfs\',
        \'list\', \'-r\', \'-t\', \'snapshot\', \'-o\', \'name\', \'-s\', \'creation\', \'storage/zvols/14362ece-fa0c-43e3-bd42-2d3b5e50af3e\']\n(0.0315961837769 seconds)\nstreams(project_id=14362ece-fa0c-43e3-bd42-2d3
        b5e50af3e,{}): \nstreams(project_id=14362ece-fa0c-43e3-bd42-2d3b5e50af3e,{}): getting streams from /storage/streams/14362ece-fa0c-43e3-bd42-2d3b5e50af3e\nstreams(project_id=14362ece-fa0c-43e3-bd42-2d3b5e50af3e,
        {}): found 1 streams\nrecv_streams(project_id=14362ece-fa0c-43e3-bd42-2d3b5e50af3e,{}): optimal stream sequence: [\'2014-03-18T20:02:52--2014-03-18T20:02:52.zvol.lz4\']\nrecv_streams(project_id=14362ece-fa0c-43
        e3-bd42-2d3b5e50af3e,{}): snapshot sequence: [\'2014-03-18T15:21:36\', \'2014-03-18T20:02:52\']\nrecv_streams(project_id=14362ece-fa0c-43e3-bd42-2d3b5e50af3e,{}): apply_starting_with = 0\nrecv_streams(project_i
        d=14362ece-fa0c-43e3-bd42-2d3b5e50af3e,{}): rollback_to = 0\ndestroy_zvol_fs(project_id=14362ece-fa0c-43e3-bd42-2d3b5e50af3e,{}): \nsudo /sbin/zpool list projects-14362ece-fa0c-43e3-bd42-2d3b5e50af3e\nsudo /sbi
        n/zfs destroy -r storage/zvols/14362ece-fa0c-43e3-bd42-2d3b5e50af3e\n(0.599976062775 seconds): \nrecv_streams(project_id=14362ece-fa0c-43e3-bd42-2d3b5e50af3e,{}): now applying 1 incoming streams\nsudo /sbin/zpo
        ol list projects-14362ece-fa0c-43e3-bd42-2d3b5e50af3e\ncat \'/storage/streams/14362ece-fa0c-43e3-bd42-2d3b5e50af3e/2014-03-18T20:02:52--2014-03-18T20:02:52.zvol.lz4\' | lz4c -d - | sudo /sbin/zfs recv -F storag
        e/zvols/14362ece-fa0c-43e3-bd42-2d3b5e50af3e\nTraceback (most recent call last):\n  File "/home/salvus/salvus/salvus/scripts/zvol_storage.py", line 903, in <module>\n    args.func(args)\n  File "/home/salvus/sa
        lvus/salvus/scripts/zvol_storage.py", line 809, in <lambda>\n    parser_recv_streams.set_defaults(func=lambda args: project.recv_streams())\n  File "/home/salvus/salvus/salvus/scripts/zvol_storage.py", line 456
        , in recv_streams\n    stream.apply()\n  File "/home/salvus/salvus/salvus/scripts/zvol_storage.py", line 192, in apply\n    cmd("cat \'%s\' | lz4c -d - | sudo /sbin/zfs recv -F %s"%(self.path, self.project.zvol
        _fs))\n  File "/home/salvus/salvus/salvus/scripts/zvol_storage.py", line 106, in cmd\n    raise RuntimeError(x)\nRuntimeError: cannot receive new filesystem stream: invalid backup stream\n\n',
            walltime: 1395186376.863 },
          { status: 'done',
 ...
 * Data wise, I will honestly have to start completely from scratch, throwing away all database computed over nearly a month (?).
 ...
 - [x] re-write `smc_storage.py` to use zvols: create zvol_storage.py; with filenames `start--end.zvol.lz4`
    ...
    shrinking a device on a pool.
     ...
     To remove dpkg -r kmod-spl-3.2.0-59-generic kmod-spl-devel kmod-spl-devel-3.2.0-59-generic spl kmod-zfs-3.2.0-59-generic kmod-zfs-devel kmod-zfs-devel-3.2.0-59-generic zfs zfs-devel zfs-dracut zfs-test
