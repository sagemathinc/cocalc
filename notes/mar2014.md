...
- [ ] modify hub to use new system when project has certain tag in the database
    ...
    update storage_servers set host='192.168.56.3', port=45167, dc=0, vnodes=128, secret='i8lvPfhW4Pagf9EHAITTDyrVdLLPhzR9LJ7ssb1a72IfXvXttgPTp0tDh7kdbes0JS3S0rW+9RxL/ASjp69Alg==' where dummy=true and server_id=1e3e131b-0302-4d54-ade4-f441c370b155;

    update storage_servers set host='192.168.56.4', port=58225, dc=1, vnodes=128, secret='LOGfprFVg3Xps7MEch1VxCrFuhguyMi7C7RwsDTFzXv1uFSEscltVZpTwXFw18QVtNrCPXjlN4jo2hz+6lQadQ==' where dummy=true and server_id=86104c94-980b-4849-a6ea-3911edee0474;


- [ ] rsync over vpn doesn't have to be encrypted -- much faster (?)
