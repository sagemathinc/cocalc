  ...
  - [ ] preparation:
          ...
          - write code that goes through each vm (or project?) and
               - delets down to RF=1
               - bup restores files to working directory -- take care with the GCE machines where that directory is /bup/projects for now
...
- [ ] backup cassandra cluster today:

nodetool snapshot salvus -t 2014-03-25
tar cvf /tmp/snapshot-2014-03-25.tar /mnt/cassandra/lib/data/salvus/*/snapshots/2014-03-25

Then use bup to put all the tarballs in one deduplicated spot.
...
- [ ] most of the LocalHub functions should be "lock and queue".
 ...
 '16f04a6d-fb82-4bd5-a13b-90d8636f45a0' = bitcoin and big
  ...
  - [x] consider again the possibility of not storing the live files longterm; only the bup repo. This is mainly to save space.    The key thing would be to include what is happening during restore in the status info for a project.  Also, replicating only the bup repos would be very, very fast and easy.
