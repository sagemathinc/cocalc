# Issues to remember
  ...
  - [ ] should I switch to RF=1 per data center?  The argument for RF=2 only makes sense for something like cassandra, where clients only talk to one dc.  For this applicaition RF=1 would seem to be fine.  (?)
