...
- [ ] (1:00?) (0:07+) spin up vm's for use as new compute vm's -- all migration runs there.
        - compute1dc0, compute2dc0, ..., compute7dc0
        - compute1dc1, compute2dc1, ..., compute10dc1
        - start storage server running on the

  - [ ] (2:00?) write migrate3 and start new migration from scratch of everything, with a 0 tolerance for errors policy and no concurrency of ZFS

  - [ ] (4:00?) write rest of code to use new system on 10.1.15.5
