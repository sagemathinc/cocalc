...
--> - [ ] write table that records only active writes

x={};require('cassandra').storage_db((e,d)->x.d=d;x.c=x.d.chunked_storage(id:'3702601d-9fbc-4e4e-b7ab-c10a79e34d3b') )

- [ ] write scrub command that deletes anything that is in the active table, but is sufficiently old (based on timestamp)
...
- [ ] add user/password auth to db

- [ ] move projects into it

- [ ] client code to get and mount projects
