...
- [ ] write as fast-enough code that returns the status of the project on all replicas, where status is enough info to do the following intelligently
...
# Overall plan
 ...
 - [ ] fix all bugs/issues in new storage system running locally on my vm's
 - [ ] setup a testing hub that uses new system and new vm's and test
 - [ ] final spin of migrations
 - [ ] snapshot database, just in case.
