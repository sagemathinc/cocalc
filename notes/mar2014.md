...
id='4b35e542-7f48-4f64-b1e0-a142efe2aca5'; d=require('storage_server').client_project(project_id:id); d.state(cb:console.log,host:true)
  ...
  - [ ] update storage servers when above finishes (?) and re-do, but for last day, instead of hour.


 - [ ] The zvol_storage queue is not working:
...
# rest of code to use new system on 10.1.15.5

-->  - [ ] (0:45+) figure out how to *not* have ~/.sagemathcloud, etc., in $HOME.
        ...
        sudo zfs create storage/dot/template
        sudo chown salvus. /storage/dot/template
        time rsync -axvH /home/salvus/salvus/salvus/scripts/skel/.sagemathcloud/   /storage/dot/template  # would update this on boot...
  ...
  - [ ] .forever: change logfile to be in ~/.sagemathcloud, as explained here: https://github.com/nodejitsu/forever-monitor
...
- [ ] (1:00?) rsync of the template

- [ ] (2:00?) create user cgroup, and make cgroup stats part of project definition
...
- [ ] (2:00?) auto-kill: make timeout part of project definition.
