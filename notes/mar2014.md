...
-->  - [ ] action queue for project object in server, so that the *server* will do at most one operation at a time...
  ...
  - [ ] auto-kill: make timeout part of project definition.
  - [ ] make cgroup stars part of project definition
  - [ ] add account
