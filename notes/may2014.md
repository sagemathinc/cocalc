# VM image update
 ...
 - [ ] update salvus repo
 - [ ] Do this:
         setcap cap_net_raw,cap_net_admin=eip /home/salvus/salvus/salvus/data/local/bin/node
...
- [ ] make a graph of tinc connection times between nodes
- [ ] add extra information / improve tinc key distribution / deal with firewall issues / static ips, etc., so all of tinc network is optimal
...
- [ ] uw tinc firewall issue


- [ ] point europe web host at europe database
- [ ] worry about cassandra firewall
- [ ] worry -- do I need to recreate indexes manually?
- [ ] sync-related timeouts: raise everything from 10 to at least 30.
...
- [ ] weird connection slowness between padelford and gce but not through 4545.  Could this be due to firewalls?
