...
- [ ] cassandra 2 upgrade
    HOW?
       ...
       - [ ] upgrade dc1
                ...
                cd salvus/salvus/; . salvus-env; nodetool drain 
                 
                cloud.stop('cassandra',host='cassandra3')
                
                sudo shutdown -h now
                
                cloud.restart('vm',hostname='cassandra3')
                
                cloud.start('cassandra',host='cassandra3')
