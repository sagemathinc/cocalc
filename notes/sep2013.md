- [ ] new release:
       ...
       [ ] change in /usr/local/bin/skel/.bashrc
...
There's a new version with the following changes.
   ...
   - Upgrade codemirror to version 3.16.
       New editing modes:
   ...
   - I made the color theme names for the terminal match the editor names.  Also, as a bonus, I added
     two new Raven themes from: https://github.com/baskerville/xresources-color-schemes
     (If anybody wants to add a bunch more themes, email me.)
...
--> - [ ] (2:00?) terminal: display/echoing of control codes on reconnect
...
- [ ] terminal concern: what if the channel unicode character is sent over the channel? hmmm...  In tests, it works fine.  䡈 Neato.

- [ ] terminal: needs scrollbar https://github.com/chjj/tty.js/issues/72

- [ ] (2:30?) file listing pager -- see Johan's request: https://mail.google.com/mail/u/0/?shva=1#inbox/14084ff6be8769cf

- [ ] (2:00?) password reset issues:

    - [ ] Clicking anywhere outside the password reset modal makes it vanish, which is a bad (de)sign
    - [ ] password reset broken when using mail with "Apple Mail.app Version 6.5 (1508)." and auto-open in chrome (found by Nathan Carter).
