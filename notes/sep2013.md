...
-->    - [ ] project creation: only one project = self... but don't want to killall and restart (?):
    ...
    - [ ] the cookies may all conflict with cloud.sagemath.com ones, since the domain is the same -- prefix them with base_url.
   ...
   Stage 3:
    ...
    - choose like 10 available ports on startup, and assign them all for various things -- low priority at start, but will be
