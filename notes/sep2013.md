...
v0.10.2
    ...
    - [ ] figure out exactly what firewall stuff we want for compute vm's, then figure out how to make those rules get automatically set.
...
WHAT we want:
    ...
    - [ ] figure out how to block local host access:
