   ...
   - [ ] blog post on ipython



Error sending password reset message to 'wstein@gmail.com'.
Internal error sending password reset email to wstein@gmail.com.
...
- haproxy -- needs to auto-detect nginx goes down and use up one.
...
- [ ] haproxy should load balance instead of round robin, since as is, things get very unbalanced.

- [ ] terminal password prompt in windows?  ("strange ssh behaviour" email from dima)
