...
--> - [ ] storage: diff function -- half done.

find . -newermt `ls -1 ~/.zfs/snapshot|tail -1` |grep -v "^./.sagemathcloud"|grep -v "^./.forever"

alter table projects add modified_files   map<text, text>;
