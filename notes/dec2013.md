...
- [ ] (1:00?) make migrate work when new (so doesn't whack location ever!!), then start running en mass.
- [ ] (1:30?) make sure create new project fully works.
- [ ] (1:00?) write a reco letter to test things out!   https://mail.google.com/mail/u/0/?shva=1#search/letter/143356d1610d6074
...
- [ ] (1:00?) when compute machine boots up it should copy over /etc/passwd, etc. -- we don't want all those old accounts, since accounts are created on the fly.
- [ ] change this in create_project_user.py after migration time:
