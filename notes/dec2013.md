...
- [ ] finish migration!
- [ ] spot check a bunch of projects to verify that project migration probably actually working...!
- [ ] (1:30?) user crontabs
- [ ] (1:00?) add periodic call to close_stale_projects in hub
