...
- [ ] raise simultaneous ssh connection limit

# Top priority GOALS



- [ ] *setup proper firewall* so that I can start the glusterfs with nfs to the local clients safely again, and re-start the copying process

- [ ] try out glusterfs geo-replication.  I could do the following (?):
...
- [ ] somebody improved printing: https://mail.google.com/mail/u/0/?shva=1#inbox/1424dfa44323d4aa
...
- [ ] make latex timeout configurable: then tell Rupert Hölzl <r@hoelzl.fr>
- [ ] once snapshots are under control, e.g., using zfs and user-deletable: tell Rupert Hölzl <r@hoelzl.fr>
