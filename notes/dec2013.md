# Replication of project data -- High Availability "End Game"
  ...
  - [x] (0:45?) (1:37) provision four single-core gce nodes with ZFS setup; 512GB each; -- these will be computes1-4.

  - [ ] (0:30?) add functionality to replicate command that restricts the target datacenter (command line option)

  - [ ] (0:30?) initiate push of all the data to GCE.
