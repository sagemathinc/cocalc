...
- [ ] (1:00?) project move: change username to project-id on project move
--> - [ ] (2:00?) project move: go through each snapshot until success.

- [ ] (1:00?) project move: better ui feedback on move
- [ ] (1:00?) project move: the hub needs to react to project move very quickly
