...
-->  - [ ] (0:30?) UGH. I have to have the storage user for security reasons, since there has to be a way to directly send the ZFS streams
  ...
  - (1:30?) [ ] migrate and update all
       ...
       - [ ] implement migrate again in storage.coffee, so that it can interact with database and be much more parallel.
       - [ ] make sure the rsync part of migrate completely ignores sshfs mounts.
       - [ ] run migrate and update everything again

  - [ ] (1:00?) storage2: create new project
