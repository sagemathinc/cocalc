...
- [ ] hub: automate making snapshots:
   - function in storage that gets called by hub:
            - does nothing if project isn't deployed
            -

- [ ] hub: automate replicating

- [ ] hub: restart project server should: (1) snapshot, (2) replicate, (3) start somewhere
...
- [ ] user crontabs: where do they live?  where do they run?
...
- [ ] (2:00?) get rid of port forward?  everything is over a vpn anyways, and this would increase speed (no wasted encryption).  not sure.

- [ ] (0:45?) storage2 optimization: output of replicate (actually repair snapshot list) uses too much space.
