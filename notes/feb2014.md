...
# Update GCE ubuntu:
 - [ ] storage crontab. "sudo zpool list" --> "sudo zpool list projects"; also change visudo!
 - [ ] install sshpass
 - [ ] OS updates
 - [ ] rebuild ZFS
...
--> - [ ] storage3: ensure that stream application works properly and efficiently even with old versions of streams sitting around... if multiple versions with same start/end, take the later one; if a stream is longer than another with same start, prioritize  the longer one.

- [ ] investigate replication errors -- get this all fixed.
...
- [ ] (1:00?) sage-6.1
        ...
        git fetch git://git.sagemath.org/sage.git u/ohanar/ipython-upgrade
...
- [ ] (3:00?) properly renaming and deleting files -- https://github.com/sagemath/cloud/issues/4; https://github.com/sagemath/cloud/issues/36
     - [ ] there is a `move_file` message and a `move_file` function in the hub, which clearly doesn't work.
           actual `move_file` is implemented via a mv command that is directly executed.
...
- [ ] (1:00?) re-automate "nodetool repair"
...
- [ ] amazing diagram library: http://www.jointjs.com/rappid
...
- [x] (0:45?) (0:29) storage: in safe move, don't re-issue the zfs rename command if one is already running...
...
-  i'm sorry, but I just can't see how my current approach to project storage scales.  Backup is way too slow. Scary.

QUESTION 1:

   - is it possible yet to move a sparse image file efficiently from one machine to another?

   - how much is dedup to blame.  Maybe we just move everything to SSD without dedup, and get a win?  Plus trim snapshots.

       - send ee808081-0a65-469f-82ec-382d4da6caa2 with dedup

            root@compute2a:/mnt/tmpdump# time zfs send -RDv projects-new/ee808081-0a65-469f-82ec-382d4da6caa2@2014-02-17T13:08:55 > ee808081-0a65-469f-82ec-382d4da6caa2
            real    0m56.783s
            user    0m1.016s
            sys     0m12.445s

       - recv ee808081-0a65-469f-82ec-382d4da6caa2 without dedup


            time cat ee808081-0a65-469f-82ec-382d4da6caa2 | zfs recv -v projects-new/ee808081-0a65-469f-82ec-382d4da6caa2
            real    1m45.824s
            user    0m0.112s
            sys     0m6.648s
       ...
       - send without dedup
            ...
            root@compute2a:/mnt/tmpdump# time zfs send -RDv projects-new/ee808081-0a65-469f-82ec-382d4da6caa2@2014-02-17T13:08:55 > ee808081-0a65-469f-82ec-382d4da6caa2-nodedup

            real    1m3.420s
            user    0m6.696s
            sys     0m12.089s

       - use image: (NOT on SSD)

            root@compute2a:/mnt/tmpdump/img2# truncate -s5G 0.img
            root@compute2a:/mnt/tmpdump/img2# zpool create test0 -f `pwd`/0.img
            root@compute2a:/mnt/tmpdump/img2# zfs set dedup=on test0
            root@compute2a:/mnt/tmpdump/img2# zfs set compression=lz4 test0
            root@compute2a:/mnt/tmpdump/img2# cd ..; time cat ee808081-0a65-469f-82ec-382d4da6caa2 | zfs recv -v test0/ee808081-0a65-469f-82ec-382d4da6caa2
            real    3m51.505s
            user    0m0.112s
            sys     0m6.968s

            root@compute2a:/mnt/tmpdump# ls -lhts img2
            total 341M
            341M -rw------- 1 root root 5.0G Feb 18 01:25 0.img
            root@compute2a:/mnt/tmpdump# time bsdtar cfv img2.tar img2
            real    0m8.543s
            user    0m0.052s
            sys     0m8.489s
            root@compute2a:/mnt/tmpdump# ls -lht img2.tar
            -rw------- 1 root root 341M Feb 18 01:31 img2.tar
            root@compute2a:/mnt/tmpdump# time lz4c img2.tar
            Compressed filename will be : img2.tar.lz4
            Compressed 357531136 bytes into 156606199 bytes ==> 43.80%
            root@compute2a:/mnt/tmpdump# mkdir x; cd x; time cat ../img2.tar.lz4 | lz4c -d - | tar xvf -
            img2/
            img2/0.img
            real    0m15.314s
            real    0m1.402s

    - Try some suggestions from Keith:

            zfs set sync=disabled projects-new
            root@compute2a:/mnt/tmpdump# time zfs send -D projects-new/ee808081-0a65-469f-82ec-382d4da6caa2@2013-12-31T23:21:19 > first
            real    0m1.868s
            user    0m0.380s
            sys     0m1.104s
            root@compute2a:/mnt/tmpdump# time zfs send -DI projects-new/ee808081-0a65-469f-82ec-382d4da6caa2@2013-12-31T23:21:19 projects-new/ee808081-0a65-469f-82ec-382d4da6caa2@2014-02-17T13:08:55 > rest
            real    0m53.126s
            root@compute2a:/mnt/tmpdump# time cat first | zfs recv -v projects-new/ee808081-0a65-469f-82ec-382d4da6caa2
            receiving full stream of projects-new/ee808081-0a65-469f-82ec-382d4da6caa2@2013-12-31T23:21:19 into projects-new/ee808081-0a65-469f-82ec-382d4da6caa2@2013-12-31T23:21:19
            received 30.2MB stream in 1 seconds (30.2MB/sec)
            real    0m0.737s
            root@compute2a:/mnt/tmpdump# time cat rest | zfs recv -v projects-new/ee808081-0a65-469f-82ec-382d4da6caa2
            real    1m39.491s

- [x] (0:15?) check on backup vm; shutdown and start making a copy of the qcow2 to usb disk.
...
- [x] figure out the allowed uid range for fuse and node.js:
      ANSWER: anything < 2^31, so exactly half of projects will be impacted...
...
- [ ] for each project (of *all* of them):
         create a file project-projectid-date.lz4
      that is a ZFS filesystem that:
         - has one snapshot at date
         - contains 0.img -- contains a zpool named "project-projectid" with the actual project's filesystem in it as project-projectid/project with mountpoint not set.
         - contains uid -- file that has the uid in it; create_project_user.py can just use this.

    Do by hand on a project:

    Not change uid:

        root@compute2a:/mnt/tmpdump# zfs create projects-new/x
        root@compute2a:/mnt/tmpdump# zfs create projects-new/x/0042ff4e-c609-42ad-98f9-85347a954684
        root@compute2a:/mnt/tmpdump# zfs set mountpoint=/projects-new/x/0042ff4e-c609-42ad-98f9-85347a954684 projects-new/x/0042ff4e-c609-42ad-98f9-85347a954684
        root@compute2a:/mnt/tmpdump# truncate -s5G /projects-new/x/0042ff4e-c609-42ad-98f9-85347a954684/0.img
        root@compute2a:/mnt/tmpdump# zpool create project-0042ff4e-c609-42ad-98f9-85347a954684 /projects-new/x/0042ff4e-c609-42ad-98f9-85347a954684/0.img
        root@compute2a:/mnt/tmpdump# zfs set dedup=on project-0042ff4e-c609-42ad-98f9-85347a954684
        root@compute2a:/mnt/tmpdump# zfs set compression=lz4 project-0042ff4e-c609-42ad-98f9-85347a954684
        root@compute2a:/mnt/tmpdump# zfs list -t snapshot -r projects/0042ff4e-c609-42ad-98f9-85347a954684|tail -1
        projects/0042ff4e-c609-42ad-98f9-85347a954684@2014-02-13T19:15:53      0      -  17.3M  -
        root@compute2a:/mnt/tmpdump# zfs send -Dv projects/0042ff4e-c609-42ad-98f9-85347a954684@2014-02-13T19:15:53 | zfs recv -vF project-0042ff4e-c609-42ad-98f9-85347a954684
        root@compute2a:/mnt/tmpdump# zpool export project-0042ff4e-c609-42ad-98f9-85347a954684
        root@compute2a:/mnt/tmpdump# zfs snapshot projects-new/x/0042ff4e-c609-42ad-98f9-85347a954684@`date +"%Y-%m-%dT%H:%M:%S"`
        root@compute2a:/mnt/tmpdump# time zfs send -RDv projects-new/x/0042ff4e-c609-42ad-98f9-85347a954684@2014-02-19T00:20:47 | lz4c - > project-0042ff4e-c609-42ad-98f9-85347a954684-2014-02-19T00:20:47.lz4

- [ ] Write a Python script migrate_to_img.py that does the above and also has a version that does this changing the uid (via technique of `zfs_chown.py`)

- [ ] Start this running on *everything* somehow (plan).
...
- [ ] backup benchmarking.
        ...
        root@compute2a:/projects-new/test-img# time cat /mnt/tmpdump/3702 | zfs recv -v img-3702601d
        real    8m7.588s

      Dump it with compression:

        # zfs snapshot projects-new/test-img@0
        # time zfs send -Dv projects-new/test-img@0 | lz4c - > /mnt/tmpdump/3702-img.lz4
        real    0m31.971s

      and resulting files is 2.2G.

      Dump it without compression: 0m49.098s and it takes 3G.  It takes longer since disk write is the limiting factor!

      Restore from compressed:

        # time cat /mnt/tmpdump/3702-img.lz4 |lz4c -d | zfs recv -v projects-new/test-img2
        received 2.95GB stream in 28 seconds (108MB/sec)
        real    0m27.671s

      Make a snapshot on the image, snapshot the imag file and update.

      root@compute2a:/test3702# time git clone salvus salvus2
        Cloning into 'salvus2'...
        done.
        real    0m2.127s   # DAMN!  yeah ssd's
        root@compute2a:/test3702# du -sch salvus2
        198M    salvus2
        198M    total

        # zfs snapshot img-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b/project@1
        # zfs snapshot projects-new/test-img@1

        root@compute2a:/projects-new/test-img# time zfs send -Dv -i projects-new/test-img@0 projects-new/test-img@1 | lz4c - > /mnt/tmpdump/3702-img-1.lz4
        send from @0 to projects-new/test-img@1 estimated size is 46.9M
        total estimated size is 46.9M
        TIME        SENT   SNAPSHOT
        real    0m0.396s

      Make 2000 more snapshots (with no changes), then send/recv img:

        root@compute2a:/mnt/tmpdump# more snapit
        #!/usr/bin/env python
        import os
        for i in range(1,2000):
            os.system("zfs snapshot img-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b/project@%s"%i)


        zfs snapshot projects-new/test-img@2
        time zfs send -Dv -i projects-new/test-img@1 projects-new/test-img@2 | lz4c - > /mnt/tmpdump/3702-img-2.lz4
        real    0m4.624s

        time zfs send -Dv -i projects-new/test-img@2 projects-new/test-img@3 | lz4c - > /mnt/tmpdump/3702-img-3.lz4
        real    0m3.712s
        root@compute2a:/projects-new/test-img# ls -lht /mnt/tmpdump/3702-img-*.lz4
        -rw------- 1 root root 279M Feb 18 23:18 /mnt/tmpdump/3702-img-3.lz4
        -rw------- 1 root root 313M Feb 18 23:02 /mnt/tmpdump/3702-img-2.lz4
        -rw------- 1 root root  31M Feb 18 18:56 /mnt/tmpdump/3702-img-1.lz4

        So... about 0.25M/snapshot, even an empty one.  Not a lot, but something.

        All

        time zfs send -Dv projects-new/test-img@3 | lz4c - > /mnt/tmpdump/3702-img.lz4
        2.8GB
        40 seconds

    Encryption for storage:

        root@compute2a:/projects-new/scratch# vi blah
        root@compute2a:/projects-new/scratch# time openssl aes-128-cbc -in 3702-img.lz4 -out 3702-img.lz4.ssl -pass file:blah
        real    0m18.681s
        root@compute2a:/projects-new/scratch# time openssl aes-128-cbc -d -in 3702-img.lz4.ssl -out 3702-img.lz4 -pass file:blah
        real    0m8.560s

Create a big filesystem on an img, then remove it and ensure that img doesn't use a lot of space.
...
- [x] figure out the allowed uid range for fuse and node.js:
      ...
      If I change it to the following, then half the time it is exactly as before, and half
      the time it is a new valid value.

            n = (hash(hashlib.sha512(uuid).digest()) % (4294967294-1000)) % (2147483646-1000)
            return n + 1001

      But it is also worrisome that the string hash function in Python is required; why not just
      fix everything and use a simpler hash, say:

            n=int(hashlib.sha512('6a63fd69-c1c7-4960-9299-54cb96523966').hexdigest()[:8], 16); ans = n if n>1000 else n+1000

      We have to change all projects instead of half. However, implementing this in Node.js (say) is easy:

            a=require('crypto').createHash('sha512'); a.update('6a63fd69-c1c7-4960-9299-54cb96523966'); s=a.digest('hex')
            n=parseInt(s.slice(0,8),'16'); ans = if n>1000 then n else n+1000

      Change all is more work, but less error prone.  Given that half of projects are broken anyways... this is probably
      the way to go to avoid weirdness.


- [x] restart cassandra and web vm's on cloud15 and services.


----


I really need to implement yet another new ZFS-based storage system that will scale well.  I want to do this efficiently.

- [ ] test complete process of putting a project in database, pulling it out, updating it, combining together streams.  document and time each command line step:

    - [ ] make `project_images` table in salvus keyspace (for now):

            CREATE TABLE images
                project_id uuid,
                start      timestamp, // undefined = first stream
                end        timestamp,
                number     int,       // we split stream from snap0 to snap1 into multiple db entries; 0, 1, 2, 3, ...
                stream     blob,
                PRIMARY KEY (project_id, start, end, number)
            );

    - [ ] create image file for 3702601d-9fbc-4e4e-b7ab-c10a79e34d3b

            root@compute13a:~/images# pwd
            /root/images
            root@compute13a:~/images# time truncate -s128G 3702601d-9fbc-4e4e-b7ab-c10a79e34d3b.img
            real    0m0.002s
            user    0m0.000s
            sys     0m0.000s
            root@compute13a:~/images# ls -lhts
            total 0
            0 -rw------- 1 root root 128G Feb 24 03:26 3702601d-9fbc-4e4e-b7ab-c10a79e34d3b.img
            root@compute13a:~/images# zpool create pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b `pwd`/3702601d-9fbc-4e4e-b7ab-c10a79e34d3b.img
            root@compute13a:~/images# zpool list pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b
            NAME                                        SIZE  ALLOC   FREE    CAP  DEDUP  HEALTH  ALTROOT
            pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b   127G   124K   127G     0%  1.00x  ONLINE  -
            root@compute13a:~/images# cd /pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b/
            root@compute13a:/pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# truncate -s10G 0.img
            root@compute13a:/pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# time zpool create project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b `pwd`/0.img
            root@compute13a:/pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# ls /project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b
            root@compute13a:/pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# zfs set compression=lz4 project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b
            root@compute13a:/pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# zfs set dedup=on project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b
            root@compute13a:/pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# time rsync -axH /projects/3702601d-9fbc-4e4e-b7ab-c10a79e34d3b/ /project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b/
            real    4m39.041s
            root@compute13a:/project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# zfs snapshot project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b@2014-02-24T03:54:50
            root@compute13a:/project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# sync
            root@compute13a:/project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# zfs snapshot pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b@2014-02-24T03:54:50
            root@compute13a:/project-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b# time zfs send -D pool-3702601d-9fbc-4e4e-b7ab-c10a79e34d3b@2014-02-24T03:54:50 | lz4c - > 3702601d-9fbc-4e4e-b7ab-c10a79e34d3b@2014-02-24T03:54:50-2014-02-24T03:54:50.lz4
            ## OOPS, pushing output into input -- and at this point, I tried to rollback and now everything is STUCK.  ZFS is a PAIN.

        Restart, but using different names -- will verify that one hang/mistake doesn't impact anything else!

            root@compute13a:~/images# time truncate -s10G 0.img
            real    0m0.002s
            root@compute13a:~/images# zpool create pool-0 `pwd`/0.img
            root@compute13a:~/images# ls /pool-0
            root@compute13a:~/images# cd /pool-0
            root@compute13a:/pool-0# time truncate -s10G 0.img
            real    0m0.002s
            root@compute13a:/pool-0# zpool create project-0 `pwd`/0.img
            root@compute13a:/pool-0# zfs set dedup=on project-0
            root@compute13a:/pool-0# zfs set compression=lz4 project-0
            root@compute13a:/pool-0# time rsync -axH /projects/3702601d-9fbc-4e4e-b7ab-c10a79e34d3b/ /project-0/
            real    2m47.284s
            root@compute13a:/pool-0# zfs snapshot project-0@2014-02-24T04:31:00; sync; zfs snapshot pool-0@2014-02-24T04:31:00
            root@compute13a:/pool-0# time zfs send -D pool-0@2014-02-24T04:31:00 | lz4c - > /root/images/0-2014-02-24T04:31:00-2014-02-24T04:31:00.lz4
            real    0m15.837s
            root@compute13a:~/images# ls -lht /root/images/*.lz4
            total 2.6G
            -rw------- 1 root root 981M Feb 24 04:37 0-2014-02-24T04:31:00-2014-02-24T04:31:00.lz4

            salvus@cloud3:~/tmp$ scp root@10.1.13.4:images/*.lz4 .
            root@10.1.13.4's password:
            0-2014-02-24T04:31:00-2014-02-24T04:31:00.lz4                                                             100%  981MB  25.2MB/s   00:39



    - [ ] create lz4 file for 3702601d-9fbc-4e4e-b7ab-c10a79e34d3b and copy to a web machine (so has db access)
    - [ ] save to database

            coffee> misc=require('misc'); s=require('storage'); s.init()
            coffee> data=fs.readFileSync("/home/salvus/tmp/0-2014-02-24T04:31:00-2014-02-24T04:31:00.lz4")
            <Buffer 04 22 4d 18 64 70 b9 43 f4 2d 00 13 00 01 00 93 ac cb ba f5 02 00 00 00 1d 10 00 40 2b cc 0a 53 0b 00 00 14 00 00 02 00 80 85 bb 0a 91 d2 44 fc e1 0c 00 ...>
            coffee> data.length   # just over 1GB!
            1028581252
            coffee> db=s.db();0;
            0
            # Try to store 100MB right off
            coffee> data.length/10
            102858125.5
            coffee> t=misc.walltime(); db.conn.execute('update images set stream=? where project_id=3702601d-9fbc-4e4e-b7ab-c10a79e34d3b', [data.slice(0,102858125)], 1,    (e)->console.log(e,misc.walltime(t)))
            coffee> null 24.03600001335144
            # Try the full Gigabyte? NOPE.
            coffee> t=misc.walltime(); db.conn.execute('update images set stream=? where project_id=3702601d-9fbc-4e4e-b7ab-c10a79e34d3b', [data], 1,    (e)->console.log(e,misc.walltime(t)))
            undefined
            coffee> FATAL ERROR: CALL_AND_RETRY_0 Allocation failed - process out of memory

    So in probably about 240 seconds we could definitely store this 1GB image, but will have to store as chunks.
    But note that we were pushing to database on the same host, so optimal network conditions.


    - [ ] read from database on another machine and mount everything
    - [ ] make changes and snapshot a hundred times
    - [ ] create image update file
    - [ ] put in database
    - [ ] read from db on another machine and mount



PLAN:

   - I will not use a database for actual project storage
   - Investigate using zvol's again

        root@compute2a:/home/salvus# time zfs create -s -V 10G projects-new/testzvol
        real    0m0.565s
        root@compute2a:/home/salvus# zpool create testzvol /dev/zvol/projects-new/testzvol
        root@compute2a:/home/salvus# zfs set compression=lz4 testzvol
        root@compute2a:/home/salvus# zfs set dedup=on testzvol
        root@compute2a:/home/salvus# zfs snapshot projects-new/testzvol@init
        root@compute2a:/home/salvus# time zfs send -D projects-new/testzvol@init | lz4c - > /tmp/testzvol.lz4
        real    0m0.073s
        user    0m0.008s
        sys     0m0.028s
        root@compute2a:/home/salvus# ls -lht /tmp/testzvol.lz4
        -rw------- 1 root root 54K Feb 24 14:48 /tmp/testzvol.lz4
        root@compute2a:/home/salvus# time rsync -axH 10.1.16.4:/projects/3702601d-9fbc-4e4e-b7ab-c10a79e34d3b/ /testzvol/
        real    3m7.323s
        root@compute2a:/home/salvus# time sync
        real    0m5.919s
        root@compute2a:/home/salvus# zfs snapshot projects-new/testzvol@rsync
        root@compute2a:/home/salvus# time zfs send -D projects-new/testzvol@rsync | lz4c - > /tmp/testzvol.lz4
        real    0m54.785s
        root@compute2a:~# ls -lht /tmp/testzvol.lz4
        -rw------- 1 root root 869M Feb 24 14:58 /tmp/testzvol.lz4
        root@compute2a:/home/salvus# time zfs send -D projects-new/testzvol@1000snaps | lz4c - > /tmp/testzvol.lz4
        real    1m2.460s

But just doing dump of 1000 snapshot project took "real    1m49.098s" *directly* with all 1000 snapshots.


        root@compute2a:/home/salvus# zfs create projects-new/testimg
        root@compute2a:/home/salvus# zfs set mountpoint=/projects-new/testimg/ projects-new/testimg
        root@compute2a:/home/salvus# truncate -s10G /projects-new/testimg/0.img
        root@compute2a:/home/salvus# zpool create testimg /projects-new/testimg/0.img
        root@compute2a:/home/salvus# zfs set compression=lz4 testimg
        root@compute2a:/home/salvus# zfs set dedup=on testimg
        root@compute2a:/home/salvus# time rsync -axH 10.1.16.4:/projects/3702601d-9fbc-4e4e-b7ab-c10a79e34d3b/ /testimg/
        root@10.1.16.4's password:
        real    2m32.203s
        root@compute2a:/home/salvus# time zfs snapshot projects-new/testimg@init
        root@compute2a:/home/salvus# time zfs send -D projects-new/testimg@init | lz4c - > /tmp/testzimg.lz4
        real    0m11.432s
        root@compute2a:/home/salvus# ls -lht /tmp/testzimg.lz4
        -rw------- 1 root root 935M Feb 24 15:18 /tmp/testzimg.lz4
        # run script to make snapshots...
        root@compute2a:/home/salvus# zfs snapshot projects-new/testimg@after1000
        root@compute2a:/home/salvus# time zfs send -D projects-new/testimg@after1000 | lz4c - > /tmp/testzimg-with1000.lz4
        real    0m12.336s
        root@compute2a:/home/salvus# time zfs send -D -i projects-new/testimg@init projects-new/testimg@after1000 | lz4c - > /tmp/testzimg-to1000inc.lz4
        real    0m7.550s


 - [x] try again more cleverly to reconstruct the snapshot history by being more careful and copying exactly the changed files as root so permissions work out right...  We really want to maintain that history!


Here's the plan:

   - update the create_project_user.py script to be the new `smc_user.py` script, which will have command-line options to do each operation we need.   Then add functionality to storage.coffee to enable using it in parallel and from hub. So have a python/coffeescript hybrid.

Design:

 - Python script for control
 - filesystem that contains a file "image" that is sparse and 128GB.
 - create zpool in it with small quota, since many images = slower.
        root@compute2a:/images# zfs create projects-new/dev0
        root@compute2a:/images# cd /projects-new
        root@compute2a:/projects-new# cd dev0
        bash: cd: dev0: No such file or directory
        root@compute2a:/projects-new# cd ..
        root@compute2a:/# zfs set mountpoint=/projects-new/dev0 projects-new/dev0
        root@compute2a:/# cd /projects-new/dev0
        root@compute2a:/projects-new/dev0# ls
        root@compute2a:/projects-new/dev0# truncate -s128G image
        root@compute2a:/projects-new/dev0# zpool create dev0 image
        cannot open 'image': no such device in /dev
        must be a full path or shorthand device name
        root@compute2a:/projects-new/dev0# zpool create dev0 `pwd`/image
        root@compute2a:/projects-new/dev0# zfs set quota=5G dev0
        root@compute2a:/projects-new/dev0# zpool list dev0
        NAME   SIZE  ALLOC   FREE    CAP  DEDUP  HEALTH  ALTROOT
        dev0   127G   198K   127G     0%  1.00x  ONLINE  -
        root@compute2a:/projects-new/dev0# zfs list dev0
        NAME   USED  AVAIL  REFER  MOUNTPOINT
        dev0   110K  5.00G    30K  /dev0

 - make the zpool uncompressed and not dedup'd: this avoids stupidly doing it twice.  Instead we make sure the containing
   zpool is deduped and compressed, which evidently ensures the "zfs send" is deduped.   This will make it so what we sell
   users is much clearer -- they get k GB, even if it doesn't cost *me* that much.   This also avoids wasted cpu/RAM.

 - make it easy for users to delete snapshots -- by doing so we don't loose the history of image files, which has all snapshots, and will be archived in backups/slow storage forever.   Deleting snapshots means that my sparse image files keep getting bigger but not shrinking.  Maybe instead I can just be more generous with space and keep all snapshots. That's really the goal.  ok.  NOTE -- we can *offline* recompact the image by recreating it via a zfs send/recv.



I hit a ZFS deadlock on 10.1.2.4

    Feb 27 00:40:00 compute2a kernel: [581311.837873] SPL: Fixing allocation for task txg_sync (16783) which used GFP flags 0xcbdd1bcc with PF_NOFS set
    Feb 27 00:40:00 compute2a kernel: [581311.837877] SPL: Showing stack for process 16783
    Feb 27 00:40:00 compute2a kernel: [581311.837881] Pid: 16783, comm: txg_sync Tainted: P           O 3.2.0-58-generic #88-Ubuntu
    Feb 27 00:40:00 compute2a kernel: [581311.837884] Call Trace:
    Feb 27 00:40:00 compute2a kernel: [581311.838039]  [<ffffffffa00274d7>] spl_debug_dumpstack+0x27/0x40 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838049]  [<ffffffffa003a904>] sanitize_flags.part.11+0x68/0x764 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838058]  [<ffffffffa002c56d>] kmem_alloc_debug+0x31d/0x3d0 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838066]  [<ffffffff81318289>] ? put_dec+0x59/0x60
    Feb 27 00:40:00 compute2a kernel: [581311.838070]  [<ffffffff8131915f>] ? number.isra.2+0x31f/0x350
    Feb 27 00:40:00 compute2a kernel: [581311.838078]  [<ffffffffa0030410>] task_alloc+0x1a0/0x350 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838085]  [<ffffffffa002c2e6>] ? kmem_alloc_debug+0x96/0x3d0 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838302]  [<ffffffffa0139f20>] ? spa_add+0x4f0/0x4f0 [zfs]
    Feb 27 00:40:00 compute2a kernel: [581311.838316]  [<ffffffffa0030c8b>] taskq_dispatch_delay+0x19b/0x2b0 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838328]  [<ffffffffa003223b>] ? taskq_cancel_id+0xeb/0x1e0 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838360]  [<ffffffffa012ca82>] spa_sync+0x1f2/0xae0 [zfs]
    Feb 27 00:40:00 compute2a kernel: [581311.838366]  [<ffffffff8103ed25>] ? pvclock_clocksource_read+0x55/0xf0
    Feb 27 00:40:00 compute2a kernel: [581311.838370]  [<ffffffff8103de89>] ? kvm_clock_get_cycles+0x9/0x10
    Feb 27 00:40:00 compute2a kernel: [581311.838406]  [<ffffffffa013dcef>] txg_sync_thread+0x2df/0x540 [zfs]
    Feb 27 00:40:00 compute2a kernel: [581311.838439]  [<ffffffffa013da10>] ? txg_init+0x250/0x250 [zfs]
    Feb 27 00:40:00 compute2a kernel: [581311.838448]  [<ffffffffa002fcb8>] thread_generic_wrapper+0x78/0x90 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838455]  [<ffffffffa002fc40>] ? __thread_create+0x310/0x310 [spl]
    Feb 27 00:40:00 compute2a kernel: [581311.838464]  [<ffffffff8108b63c>] kthread+0x8c/0xa0
    Feb 27 00:40:00 compute2a kernel: [581311.838519]  [<ffffffff8166c534>] kernel_thread_helper+0x4/0x10
    Feb 27 00:40:00 compute2a kernel: [581311.838526]  [<ffffffff8108b5b0>] ? flush_kthread_worker+0xa0/0xa0
    Feb 27 00:40:00 compute2a kernel: [581311.838531]  [<ffffffff8166c530>] ? gs_change+0x13/0x13
...
- [ ] setup monitoring of DNS: https://mail.google.com/mail/u/0/?shva=1#inbox/144538774bd4ed04
...
Base image update
 - [x] storage crontab. "sudo zpool list" --> "sudo zpool list projects"; also change visudo!
 - [x] install sshpass
 - [x] OS updates
 - [x] rebuild ZFS
 - [x] push out new base image and reboot everything using 10.1.21.*

  - [x] I'm trying `zfs set sync=disabled projects; zfs set sync=disabled projects-new` on the pool on 10.1.2.4, to see if that helps
       with the deadlock problems. Also, I'm doing one project at a time.  Period.
       It seems to have helped -- no deadlock all night!

 - [x] storage3: implement quota support for migration script

 - [x] storage3: figure out how to run on multiple machines without replicating work already done: create a query in database to get list of all project id's of projects that are on machine a, but not machines b,c,...


 - [x] investigate using ceph-0.72 to store streams, so that *any* compute node can run any project, and compute nodes are all identical (except that they have ceph data on them?)  NO -- just stop getting distracted by such...
