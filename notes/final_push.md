...
- (0:15?) [ ] implement alt-enter to evaluate without moving the cursor, since I need that for teaching.
- (0:15?) [ ] make new markdown mode that leaves content of $'s untouched (wraps them all in spans?).
