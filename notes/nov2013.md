...
- [ ] (0:45?) monitor: when something is "down", email me.

- [ ] (1:00?) fix some other unicode file issue...?
...
- [ ] (1:00?) terminal: have a special code to "start" the terminal on first connection, since "first burst" just doesn't work.  See the line " On first write we ignore any queued terminal attributes responses that result." in console.coffee  https://github.com/sagemath/cloud/issues/65
