- [ ] NEW release
   ...
   - [ ] sudo apt-get install nmon    # suggested by Harald Schilly
...
- [ ] (0:15?) monitoring: write minimal functionality needed for the "move button" -- i.e., in admin.py make the monitor put the last entry into another table too
