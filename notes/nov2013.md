...
- [ ] make neuron generally available: http://pub.ist.ac.at/~jguzman/doc/neuron/tutorial/Tutorial0.html#to-build-the-neuron-shared-library-for-python
...
- [ ] projects -- field that lists the timestamp of the last successful snapshot
...
- [ ] (0:20?) worksheet printing -- option to leave files around.

- [ ] fix json worksheet printing issue that Harald pointed out with his theano example

- [ ] bug in parsing try/except/else -- https://mail.google.com/mail/u/0/?shva=1#starred/1428eb398a87ed4e
        try:
            print('try')
        except:
            print('except')
...
- [ ] worksheet printing -- minimal gui and release something:
...
- [ ] print for other document types (use lstlisting or...?)

- [ ] maintain username on project move

- [ ] limit user cpu using cgroups

- [ ] limit user memory using cgroups

- [ ] limit user disk io using cgroups

- [ ] disk quotas -- bring them back

- [ ] hub: needs to react to project move very quickly.
