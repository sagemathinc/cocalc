...
- [] (0:45?) release a new version, but experiment with doing a rolling restart:
...
# HA
 ...
 - We really need checkpointing and live migration of containers.  That's clearly the *future*.
