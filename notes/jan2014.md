...
- [ ] fuse permissions: "chmod a+rw /dev/fuse"
...
- [ ] issue: the timeout to open a file is shorter than the time it often takes to open a closed static project. This means you get an error even though opening would actually have worked fine if given them time.

- [ ] folder rename is broken -- https://mail.google.com/mail/u/0/?shva=1#inbox/143d75c5b69aa3fe
