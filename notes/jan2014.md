...
--> - [ ] (0:15?) warm-up: "The Sagemath Cloud" --> SageMathCloud
 - [ ] get projects to work locally on my laptop and move class to one.
 - [ ] (1:00?) investigate changing the uid schema gracefully for the zpool's
 - [ ] (2:00?) course homework workflow.

 - [ ] ui for selecting from locations to move project
