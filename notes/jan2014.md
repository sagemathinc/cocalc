...
- [ ] (1:00?) fix snapshot times in Firefox and Safari

- [ ] (0:45?) latex editor should give up rendering errors after a certain number.  If there are thousands then browser hangs.

- [ ] (0:45?) add last mod timeago to directories (not just files)

- [ ] (0:15?) new project dialog -- modal-body div looks all weird.
...
- [ ] setup and start running an encrypted off-site backup of all projects
     PLAN:
         - upgrade
         - build zfs
