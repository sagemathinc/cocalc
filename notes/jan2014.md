...
- [ ] (1:00?) account creation using old Internet Explorer doesn't work.
      so, when opening the site, put a big red warning if they are using an old IE, Firefox, Chrome, etc. version.

- [ ] (1:30?) try switching to codemirror 4 beta -- maybe faster?!
