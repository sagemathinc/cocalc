...
- [ ] add last replication error to status.

- [ ] close all projects on a given machine

- [ ] move everything off of cloud1 and cloud2

- [ ] what to do about missing snasphots on targets?  maybe zfs can add those in?  These were because I neglected to use "-I", etc. 
...
FACTS:
  ...
  - [ ] in all cases: need to lock the socket (I don't think I implemented this)
