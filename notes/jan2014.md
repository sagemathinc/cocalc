TODO:
 ...
 - [ ] (1:30?) hub: implement automatic timeout when inactive, removing existing code; honor database field to ignore timeouts

 - [ ] (0:45?) look at, try, new print script: https://mail.google.com/mail/u/0/?shva=1#search/sagews2pdf.py/142eb9b3780afd83
 ...
 - [ ] (0:30?) do the switch:
         ...
         - [ ] shut off all hubs
             - [ ] do another migrate
             - [ ] at same time, upgrade all code on hubs (including upgrading salvus_version!)
         - [ ] start all hubs and restart nginx's
