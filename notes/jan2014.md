...
- [ ] bug: fuse is now broken for users. UGH. -- this is because of BIG uid's....
      Idea to fix this:
...
- [ ] (1:00?) storage: replication loop -- in this case 10.1.12.4 gets deleted one time, then 10.1.14.4 overwrites it in stage 2, ad infinitum.
...
- [ ] automate zpool scrub's -- started one manually on compute1, 10, and 10.3.1.4 -- see how they do first.
