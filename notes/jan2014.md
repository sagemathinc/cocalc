...
- [ ] (1:30?) (0:10+) upgrade to newest sock.js: version=0.3.4.26.gf002; upgrade sockjs, which has seen new development: https://github.com/sockjs/sockjs-client/commits/master
    - it looks good, but... impossible without internet.
