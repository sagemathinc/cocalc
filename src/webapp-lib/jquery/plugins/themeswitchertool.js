...
$.fn.themeswitcher = function (settings) {
  ...
  var button_default = {
    ...
    color: "#666",
    background:
      "#eee url(http://jqueryui.com/themeroller/themeswitchertool/images/buttonbg.png) 50% 50% repeat-x",
  ...
  button
    ...
    .css({
      ...
      height: "16px",
      background:
        "url(http://jqueryui.com/themeroller/themeswitchertool/images/icon_color_arrow.gif) 50% 50% no-repeat",
    });
  //pane css
  switcherpane
    .css({
    ...
    .hover(
      function () {
        $(this).css({
          borderColor: "#555",
          background:
            "url(http://jqueryui.com/themeroller/themeswitchertool/images/menuhoverbg.png) 50% 50% repeat-x",
          cursor: "pointer",
        });
      },
      function () {
