  ...
  function e(e) {
    return this.each(function () {
      var n = t(this),
        ...
        r = "object" == typeof e && e;
      (i || "destroy" != e) &&
        (i || n.data("bs.tooltip", (i = new o(this, r))),
        "string" == typeof e && i[e]());
    });
  }
  var o = function (t, e) {
  ...
  (o.VERSION = "3.2.0"),
    ...
    (o.prototype.show = function () {
      ...
      if (this.hasContent() && this.enabled) {
        ...
        if (p) {
          ...
          (s =
            "bottom" == s && h.top + h.height + u - f.scroll > f.height
              ? "top"
              : "top" == s && h.top - f.scroll - u < 0
              ? "bottom"
              : "right" == s && h.right + l > f.width
              ? "left"
              : "left" == s && h.left - l < f.left
              ? "right"
              : s),
        ...
        t.support.transition && this.$tip.hasClass("fade")
          ? i.one("bsTransitionEnd", v).emulateTransitionEnd(150)
          : v();
      }
    }),
    ...
    (o.prototype.hide = function () {
      ...
      return (
        ...
        i.isDefaultPrevented()
          ...
          : (n.removeClass("in"),
            t.support.transition && this.$tip.hasClass("fade")
              ? n.one("bsTransitionEnd", e).emulateTransitionEnd(150)
              : e(),
    ...
    (o.prototype.getCalculatedOffset = function (t, e, o, n) {
      return "bottom" == t
        ...
        : "top" == t
        ? { top: e.top - n, left: e.left + e.width / 2 - o / 2 }
        : "left" == t
        ? { top: e.top + e.height / 2 - n / 2, left: e.left - o }
    ...
    (o.prototype.getViewportAdjustedDelta = function (t, e, o, n) {
      ...
      if (/right|left/.test(t)) {
        ...
        h < s.left
          ? (i.left = s.left - h)
          : l > s.width && (i.left = s.left + s.width - l);
      }
      return i;
    }),
    ...
    function e(e) {
      return this.each(function () {
        var n = t(this),
          ...
          r = "object" == typeof e && e;
        (i || "destroy" != e) &&
          (i || n.data("bs.popover", (i = new o(this, r))),
          "string" == typeof e && i[e]());
      });
    }
    var o = function (t, e) {
        ...
        return (
          ...
          (o.prototype._showNextStep = function () {
            ...
            return (
              ...
              (t = this._makePromise(
                null != o.onNext ? o.onNext(this) : void 0
              )),
          ...
          (o.prototype._showPrevStep = function () {
            ...
            return (
              ...
              (t = this._makePromise(
                null != o.onPrev ? o.onPrev(this) : void 0
              )),
              this._callOnPromiseDone(t, e)
            );
          }),
          ...
          (o.prototype._template = function (e, o) {
            var n, i, r, s;
            return (
              (s = t.isFunction(e.template)
                ? t(e.template(o, e))
                : t(e.template)),
              (n = s.find(".popover-navigation")),
              (r = n.find('[data-role="prev"]')),
              (i = n.find('[data-role="next"]')),
              this._isOrphan(e) && s.addClass("orphan"),
              s.addClass(
                "tour-" +
                  this._options.name +
                  " tour-" +
              ...
              e.prev < 0 && n.find('[data-role="prev"]').addClass("disabled"),
              e.next < 0 && n.find('[data-role="next"]').addClass("disabled"),
              e.duration || n.find('[data-role="pause-resume"]').remove(),
          ...
          (o.prototype._reposition = function (e, o) {
            ...
            if (
              ...
              (p = l.left),
              (h = l.top),
              (i = t(n).outerHeight() - l.top - e.outerHeight()),
              0 > i && (l.top = l.top + i),
              (s = t("html").outerWidth() - l.left - e.outerWidth()),
              0 > s && (l.left = l.left + s),
              l.top < 0 && (l.top = 0),
              l.left < 0 && (l.left = 0),
              e.offset(l),
              ...
              if (p !== l.left)
                return this._replaceArrow(e, 2 * (l.left - p), a, "left");
            } else if (h !== l.top)
              return this._replaceArrow(e, 2 * (l.top - h), r, "top");
          }),
