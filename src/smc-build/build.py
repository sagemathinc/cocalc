...
class BuildSage(object):
    ...
    def install_R_bioconductor(self):
        ...
        self.cmd("echo '%s' | R --no-save"%c)
        c = 'library(BiocInstaller); biocLite(c("geneplotter", "limma", "puma", "affy", "edgeR", "BitSeq", "hgu95av2cdf", "hgu133plus2cdf", "affyPLM", "ddCt", "hgu95av2.db", "affydata", "hgu133plus2.db", "oligo", "limma", "gcrma", "affy", "GEOquery", "pd.mogene.2.1.st", "pd.mouse430.2", "Heatplus"))'
        self.cmd("echo '%s' | R --no-save"%c)
