...
BINARIES = [
    ...
    'ruby', 'erb', 'flex', 'm4', 'fish', '4ti2-zsolve', 'py.test', 'nosetests',
    'htop', 'h5dump', 'inkscape', 'libreoffice', 'scheme', 'nodejs', 'npm',
    'lilypond', 'lzma', 'make', 'markdown', 'mc', 'maxima', 'obspy3-plot',
    'nano', 'pypy', 'Rscript', 'rsync', 'sed', 'scons', 'sass', 'zsh',
    'echo ":quit" | scala', 'sbcl', 't1asm', 'xpra',
    ('tmux', None, '-V'),
    ('sml', None, '@SMLversion'),
    ('synctex', None, 'help'),
    ('scilab-cli', None, '-version', 1),
