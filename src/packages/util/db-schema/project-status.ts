...
Its intended use is to subscribe to it once you open a project and notify the user if certain alerts go off.

It is an ephemeral table stored in memory only in the project and clients.
*/
