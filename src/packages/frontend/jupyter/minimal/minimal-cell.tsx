    ...
    const sectionDivider = showSectionDivider ? (
      <div style={{ display: "flex" }}>
        <SectionBar
          ...
          onRunSection={zenMode ? sectionRunButton : undefined}
          style={{ flex: `${OUTPUT_FLEX_DEFAULT} 1 0` }}
        />
        {/* Code column: Run button aligned with per-cell Run buttons */}
        {showCode && sectionRunButton && (
          <SectionRunInCodeColumn
        ...
        {zenMode && minimalLayout !== "wide" && <div style={{ flex: `${CODE_FLEX_DEFAULT} 1 0` }} />}
      </div>
    ) : null;
...
/** Run button placed in the code column area of a section divider */
function SectionRunInCodeColumn({
  onRunSection,
  onToggle,
  codeFlex,
  isFirst,
  ...
  return (
    <div
      style={{
        ...
        alignItems: "center",
        padding: "0 4px",
        backgroundColor: hovered ? COLORS.GRAY_LL : COLORS.GRAY_LLL,
