  ...
  return (
    <div style={style}>
      ...
      >
        ...
        which is <b>very fast</b>. Also, if you include <code>*</code> in the
        list below, then the sync process is temporarily disabled, though your
        HOME directory is still mounted over the network.
      </Tooltip>
      <Select
        value={value}
        disabled={
