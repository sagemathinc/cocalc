...
export default function ExplorerTour({
  ...
  const steps: TourProps["steps"] = [
    ...
    },
    {
      ...
      description: (
        <>
          Your files are shown as a sortable table. Click column headings to
          sort by name, size, date, or type. Click a folder to navigate into it,
          or click the expand arrow to peek at its contents inline without
          leaving the current directory. Long-press any file to drag it to
          another folder or breadcrumb to move it; hold Shift while dropping to
          copy instead.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          Auto-generated temporary files (e.g., LaTeX output) are shown dimmed.
          Click the mask icon button to completely hide them for the current
          directory. This is a temporary toggle that resets when you navigate to
          a different folder.
        </>
      ),
      target: miscButtonsRef.current,
