...
const REQUIRED_SINGLE_SERVER_SEND_MESSAGES_PER_SECOND = 1000;

const REQUIRED_VALKEY_SERVER_RECV_MESSAGES_PER_SECOND = 1000;
const REQUIRED_VALKEY_SERVER_SEND_MESSAGES_PER_SECOND = 200;
