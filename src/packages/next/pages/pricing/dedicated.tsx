        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: "12pt" }}>
              ...
              <p>
                Upgrade one of your projects to run on a <b>Dedicated VM</b>.
                This is an additional node in {siteName}'s cluster, where
                resources are not shared with other projects. That machine can
                be <b>much</b> larger than any of our generic machines as well.
                This allows you to run much more intensive workloads with
                consistent performance, because the usual quota limitations do
                not apply. You can also rent additional disk space for faster
                additional storage.
              </p>
              <p>
                The list of dedicated VM options below are just examples. Visit
                the <A href={"/store/dedicated?type=vm"}>Dedicated VM Store</A>{" "}
                to see current options. Besides that, we can provide VM's with
              ...
              <p>
                A <strong>Dedicated Disk</strong> is an additional storage
                device mounted into your project. Their{" "}
                ...
                of operations per second up to fast SSD disks. You do not need
                to rent a Dedicated VM in order to subscribe to a Dedicated
                Disk.
              </p>
              <p>
                The list of dedicated disk options below are just exmples. Visit
                the{" "}
                <A href={"/store/dedicated?type=disk"}>Dedicated Disk store</A>{" "}
                to see available options. Usual disk sizes are{" "}
