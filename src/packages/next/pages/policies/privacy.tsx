        ...
        >
          ...
          <div style={{ fontSize: "12pt" }}>
            <p>
              ...
              mind, we’re providing this Privacy Policy to explain our practices
              regarding the collection, use and disclosure of information that
              we receive through our Services. This Privacy Policy does not
              ...
              meanings as in our Terms of Service. So, please make sure that you
            ...
            <p>
              ...
              collected. We may revise this Privacy Policy from time to time. If
              we make any material changes to this Privacy Policy, we’ll notify
              you of those changes by posting them on the Services or by sending
              you an email or other notification, and we’ll update the "Revision
              history" below to indicate when those changes will become
              effective.{" "}
            </p>
            <div id="purpose">
              <h1>1 Purpose</h1>
              <p>
                ...
                <strong>“us”</strong> include Sagemath, Inc. and our affiliates
                and subsidiaries. This Privacy Policy explains our online and
                offline information practices, the kinds of information we may
                collect, how we intend to use and share that information, and
                how you can opt out of a use or correct or change such
                information. All other terms not defined in Section 13 or
                otherwise herein will have the meanings set forth in the Terms.
              </p>
            </div>
            <div id="scope">
              <h1>2 Scope</h1>
              ...
              <p>
                ...
                Sagemath commits to cooperate with EU data protection
              ...
              <p>
                ...
                affiliates certified under the Privacy Shield and any additional
              ...
              <p>
                ...
                the Transition Period from January 31, 2020, until December 31,
                2020.{" "}
              </p>{" "}
            </div>{" "}
            <div id="transparencynoticetypes-of-personal-information-we-collect-and-how-we-use-it">
              ...
              <p>
                ...
                you or from Third-Party sources) and our privacy practices
                depend on the nature of the relationship you have with Sagemath
                and the requirements of applicable law. Some of the ways that
                Sagemath may collect Personal Information include:{" "}
              </p>{" "}
              <ul>
                {" "}
                <li>
              ...
              <div id="types-of-personal-information-we-collect">
                ...
                <p>
                  ...
                  prospective, and former clients, customers, users, visitors,
                  guests, and Employees (collectively{" "}
                ...
                <p>
                  ...
                  registering for an account with Sagemath, responding to
                  surveys, requesting Services or information, or contacting us
                  directly, we may ask you to provide some or all of the
                ...
                <ul>
                  <li>
                    <p>
                      ...
                      Personal Information from you such as email address, phone
                      number or mailing address when you choose to request
                      information about our Services, register for Sagemath’s
                      newsletter or a loyalty program that we may offer, request
                      to receive customer or technical support, or otherwise
                      communicate with us.{" "}
                    </p>{" "}
                  </li>{" "}
                  <li>
                    ...
                    <p>
                      ...
                      include Personal Information. All information collected
                      from your participation in our surveys is provided by you
                      voluntarily.{" "}
                    </p>{" "}
                  </li>{" "}
                  <li>
                    ...
                    <p>
                      ...
                      offer publicly accessible forums, blogs, and social media
                      pages. You should be aware that, when you disclose
                      information about yourself in on Sagemath’s forums, blogs,
                      and social media pages, the Services will collect the
                      information you provide in such submissions, including any
                      Personal Information. If you choose to submit content to
                      any public area of the Site, such content will be
                ...
                <p>
                  ...
                  advertising identifiers, MAC address, details about your
                  browser or device, geo-location information, Internet service
                  provider, pages that you visit before and after using the
                  Services, and other information about how you use the
                  Services.{" "}
                </p>{" "}
                <p>
                  {" "}
              ...
              <div id="how-sagemath-uses-your-information">
                ...
                <ul>
                  ...
                  <li>
                    To notify you about offers, products, and services that may
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      information that we may use alone or in the aggregate with
                      information obtained from other sources, in order to help
                      us to optimally deliver our existing products and Services
                      or develop new products and Services. We may share
                      anonymous Individual and aggregate data for research and
                      analysis purposes.{" "}
                    </p>{" "}
                  </li>{" "}
                  <li>
                    ...
                    <p>
                      ...
                      phone calls from us with information on Sagemath’s or our
                      business partners’ products and services or upcoming
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      information about you to create anonymized and aggregated
                      ...
                      access Sagemath’s Services, or other analyses we create.
                      Anonymized or aggregated information is not Personal
                      Information, and Sagemath may use such information in a
                      number of ways, including research, internal analysis,
                      analytics, and any other legally permissible purposes. We
                      may share this information within Sagemath and with Third
                      Parties for our or their purposes in an anonymized or
                      aggregated form that is designed to prevent anyone from
                      identifying you.{" "}
                    </p>{" "}
                  </li>{" "}
                  <li>
                    ...
                    <p>
                      ...
                      services, such as inviting a collaborator to a project.
                      Our referral services may allow you to forward or share
                      certain content with a friend or colleague, such as an
                      email inviting your friend to use our Services. Email
                      addresses that you may provide for a friend or colleague
                      will be used to send your friend or colleague the content
                      or link you request, but will not be collected or
                      otherwise used by Sagemath or any other Third Parties for
                      any other purpose. The Services also allow you to share
                      your content with Third Parties such as GitHub and NPM.
                      Any Personal Information you choose to share with these
                      Third Parties is not covered by this Privacy Policy. We
                      encourage you to review the privacy policy of these Third
                      Parties before submitting your Personal Information.{" "}
                    </p>{" "}
                  </li>{" "}
                  <li>
                    {" "}
              ...
              <div id="cookies-pixel-tagsweb-beacons-analytics-information-and-interest-based-advertising">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      known as a web beacon) is a piece of code embedded on the
                      ...
                      or clicked on a particular advertisement. We may also
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      some of our Services, and to develop website content. This
                      analytics data is not tied to any Personal Information.
                      ...
                      data generated by your use of the Services by going to{" "}
                ...
                <p>
                  {" "}
                  If you would like to opt-out of the Technologies we employ on
                  the Services, you may do so by blocking, disabling, or
              ...
              <div id="third-party-websites-social-media-platforms-and-software-development-kits">
                ...
                <p>
                  ...
                  does not endorse or make any representations about Third-Party
                  websites or social media platforms. We encourage our users to
                  read the privacy policies of each and every website and
                ...
                <p>
                  ...
                  Information which you voluntarily include and transmit online
                  in a publicly accessible forum, blog, or social media page may
                  be viewed and used by others without any restrictions. By
              ...
              <div id="third-party-payment-processing">
                ...
                <p>
                  {" "}
                  When you make purchases through the Services, we process your
                  payments through a Third-Party application, including Stripe,
                  PayPal, (together with any similar applications,{" "}
                  ...
                  behalf of Sagemath, including your name, email address,
            ...
            <div id="human-resources-data">
              ...
              <p>
                ...
                prospective, and former Employees, their contact points in case
                of a medical emergency, and beneficiaries under any insurance
                policy (<strong>“Human Resources Data”</strong>). The Human
                Resources Data we collect may include title, name, address,
                phone number, email address, date of birth, passport number,
                driver’s license number, Social Security number or other
                government-issued identification number, financial information
                related to credit checks, bank details for payroll, information
                that may be recorded on a CV or application form, language
                abilities, contact information of third parties in case of an
                emergency and beneficiaries under any insurance policy. We may
                also collect Sensitive Human Resources Data such as details of
                health and disability, including mental health, medical leave,
                and maternity leave; information about national origin or
                immigration status; and optional demographic information such as
                race, which helps us achieve our diversity goals.{" "}
              </p>{" "}
              <p>
                {" "}
            ...
            <div id="onward-transfersagemath-may-disclose-your-information">
              ...
              <div id="information-we-share">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <p>
                      {" "}
                      <strong>We Use Vendors and Service Providers.</strong> We
                      may share any information we receive with vendors and
                      ...
                      information and services you have requested; (iii) payment
                      processing; (iv) customer service activities; and (v) in
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      Sagemath may also provide Personal Information to business
                      partners with whom we may jointly offer products or
                      services, or whose products or services we believe may be
                      of interest to you. In such cases, our business partner’s
                      name will appear, along with Sagemath. Sagemath requires
                      our affiliates and business partners to agree in writing
                      to maintain the confidentiality and security of Personal
                      Information they maintain on our behalf and not to use it
                      for any purpose other than the purpose for which Sagemath
                      provided them.{" "}
                    </p>{" "}
                  </li>{" "}
                  <li>
                    ...
                    <p>
                      ...
                      Process Personal Information in a manner inconsistent with
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      you post to the Services may be displayed on the Services.
                      Other users of the Services may be able to see some
                      information about you, such as your name. We are not
                      responsible for privacy practices of the other users who
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      advertising partners to set tracking tools (e.g., cookies)
                      to collect information regarding your activities (e.g.,
                      your IP address, page(s) visited, time of day). We may
                      also share such de-identified information as well as
                      selected Personal Information (such as demographic
                      information and past purchase history) we have collected
                      ...
                      targeted advertisements to you when you visit non-Sagemath
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      with law enforcement or national security requests and
                      legal process, such as a court order or subpoena; (ii)
                      respond to your requests; (iii) protect yours’, ours’ or
                      others’ rights, property, or safety; (iv) to enforce
                      Sagemath policies or contracts; (v) to collect amounts
                      owed to Sagemath; (vi) when we believe disclosure is
                      necessary or appropriate to prevent physical harm or
                      financial loss or in connection with an investigation or
                      prosecution of suspected or actual illegal activity; or
                      (vii) if we, in good faith, believe that disclosure is
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      diligence, reorganization, bankruptcy, receivership, sale
                      of company assets, or transition of service to another
                      provider, then your information may be sold or transferred
                      as part of such a transaction as permitted by law and/or
                      contract.{" "}
                    </p>{" "}
                  </li>{" "}
                </ul>{" "}
              ...
              <div id="international-data-transfers">
                ...
                <p>
                  ...
                  of our affiliates, or the servers of our service providers, in
            ...
            <div id="opt-out-right-to-object-to-processing">
              ...
              <div id="general">
                ...
                <p>
                  {" "}
                  You have the right to object to and opt out of certain uses of
                  your Personal Information. Where you have consented to
                  Sagemath’s Processing of your Personal Information or
                  Sensitive Personal Information, you may withdraw that consent
                  at any time and opt out of further Processing by contacting{" "}
                  <A href="mailto:office@sagemath.com">office@sagemath.com</A>.
                  Even if you opt out, we may still collect and use non-Personal
                  Information regarding your activities on our Services and/or
                  information from the advertisements on Third-Party websites
                  for non-interest based advertising purposes, such as to
              ...
              <div id="email-and-telephone-communications">
                ...
                <p>
                  ...
                  certain non-promotional communications regarding Sagemath and
                  our Services and you will not be able to opt out of those
                  communications (e.g., communications regarding updates to our
                  Terms or this Privacy Policy).{" "}
                </p>{" "}
                <p>
                  {" "}
                  We maintain telephone “do-not-call” and “do-not-mail” lists as
                  mandated by law. We process requests to be placed on
                  do-not-mail, do-not-phone and do-not-contact lists within 60
                  days after receipt, or such shorter time as may be required by
                  law.{" "}
                </p>{" "}
              </div>{" "}
              <div id="mobile-devices">
                ...
                <p>
                  {" "}
                  Sagemath may occasionally send you push notifications through
                  our mobile applications with notices that may be of interest
                  to you. You may at any time opt out from receiving these types
                  of communications by changing the settings on your mobile
                  device. Sagemath may also collect location-based information
              ...
              <div id="human-resources-data-1">
                ...
                <p>
                  ...
                  connection with the employment relationship, Sagemath will use
                  such Personal Information only for employment-related purposes
                  as more fully described above. If Sagemath intends to use this
                  Personal Information for any other purpose, Sagemath will
                  notify the Individual and provide an opportunity to opt out of
                  such uses.{" "}
                </p>{" "}
              </div>{" "}
              <div id="do-not-track">
                ...
                <p>
                  {" "}
                  Do Not Track (<strong>“DNT”</strong>) is a privacy preference
                  ...
                  time and across websites or online services. Please note that
              ...
              <div id="cookies-and-interest-based-advertising">
                ...
                <p>
                  ...
                  advertisers that participate in self-regulatory programs. You
                  can access these, and also learn more about targeted
            ...
            <div id="rights-of-access-rectification-erasure-and-restriction">
              ...
              <p>
                ...
                portability”); (iv) restrict our uses of your personal
            ...
            <div id="security-of-your-information">
              ...
              <p>
                ...
                by applicable law, we do not accept liability for unintentional
                disclosure.{" "}
              </p>{" "}
              <p>
                {" "}
                ...
                notice on the Services or sending an e-mail to you. You may have
                a legal right to receive this notice in writing.{" "}
              </p>{" "}
            </div>{" "}
            <div id="childrens-privacy">
              ...
              <p>
                ...
                and Sagemath does not knowingly collect Personal Information
                from children under 16 years of age. If we learn that we have
                collected any Personal Information from children under 16 years
                old, we will promptly take steps to delete such information.{" "}
              </p>{" "}
            </div>{" "}
            <div id="redresscompliance-and-accountability">
              ...
              <p>
                ...
                <A href="mailto:office@sagemath.com">office@sagemath.com</A>. We
                will address your concerns and attempt to resolve any privacy
                issues in a timely manner.{" "}
              </p>{" "}
              <p>
                {" "}
                If you are an EU or Swiss citizen and feel that Sagemath is not
                abiding by the terms of this Policy, or is not in compliance
                with the Privacy Shield Principles, please contact Sagemath at
                the contact information provided above.{" "}
              </p>{" "}
              <p>
                {" "}
                In addition, Sagemath has agreed to refer unresolved complaints
                related to Personal Information to JAMS Privacy Shield Dispute
                Resolution Program and, with respect to Employee and human
                resources data, has committed to cooperate with the panel
                established by local data protection authorities and comply with
                the advice given by the panel for EU citizens and with the Swiss
                Federal Data Protection and Information Commissioner’s authority
                and advice for such data of Swiss citizens. For more information
              ...
              <p>
                ...
                citizens free of charge. If any request remains unresolved, you
                may contact the national data protection authority for your EU
                Member State.{" "}
              </p>{" "}
              <p>
                {" "}
            ...
            <div id="other-rights-and-important-information">
              ...
              <div id="changes-to-our-privacy-policy-and-practices">
                ...
                <h2>
                  {" "}
                  <span>12.1</span> Changes To Our Privacy Policy and Practices{" "}
                </h2>{" "}
                <p>
                  {" "}
              ...
              <div id="california-privacy-rights">
                ...
                <p>
                  ...
                  Information disclosed to those parties. Sagemath does not
              ...
              <div id="compliance">
                ...
                <p>
                  ...
                  operating divisions, subsidiaries and affiliates. Sagemath has
                  put in place mechanisms to verify ongoing compliance with
                  Privacy Shield Principles and this Policy. Any Employee that
              ...
              <ul>
                ...
                <li>
                  ...
                  <p>
                    ...
                    Processes Personal Information pursuant to the instructions
                    of, and solely for, Sagemath or to which Sagemath discloses
                    Personal Information for use on its behalf.{" "}
                  </p>{" "}
                </li>{" "}
                <li>
                  {" "}
                  <p>
                    ...
                    director, contractor, worker, or retiree of Sagemath or its
                ...
                <li>
                  ...
                  <p>
                    ...
                    principles of the Privacy Shield Framework: (1) notice, (2),
                    ...
                    data, (2) journalistic exceptions, (3) secondary liability,
                    (4) performing due diligence and conducting audits, (5) the
                    role of the data protection authorities, (6)
                    self-certification, (7) verification, (8) access, (9) human
                    resources data, (10) obligatory contracts for onward
                    transfers, (11) dispute resolution and enforcement, (12)
                    choice – timing of opt-out, (13) travel information, (14)
                    pharmaceutical and medical products, (15) public record and
                    publicly available information, and (16) access requests by
                    public authorities.{" "}
                  </p>{" "}
                </li>{" "}
                <li>
                ...
                <li>
                  ...
                  <p>
                    ...
                    subset of Personal Information which, due to its nature, has
                    been classified by law or by policy as deserving additional
                    privacy and security protections. Sensitive Personal
                    Information includes Personal Information regarding EU
                    residents that is classified as a{" "}
                    <strong>“Special Category of Personal Data”</strong> under
                    EU law, which consists of the following data elements: (1)
                    race or ethnic origin; (2) political opinions; (3) religious
                    or philosophical beliefs; (4) trade union membership; (5)
                    genetic data; (6) biometric data where Processed to uniquely
                    identify a person; (6) health information; (7) sexual
                    orientation or information about the Individual’s sex life;
                    or (8) information relating to the commission of a criminal
                    offense.{" "}
                  </p>{" "}
                </li>{" "}
                <li>
            ...
            <div id="revision-history">
              ...
              {/* @ts-ignore */}
              <table border="1px" cellpadding="5px" style={{ margin: "auto" }}>
                <thead>
                  <tr>
