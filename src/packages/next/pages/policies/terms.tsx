...
export default function TermsOfService({ customize }) {
  return (
    <Customize value={customize}>
      <Head title="CoCalc - Terms of Service" />
        ...
        >
          ...
          <div style={{ fontSize: "12pt" }}>
            <p>
              ...
              <b>Terms</b>") carefully because they govern your use of our Site
              and services accessible via our Site. To make these Terms easier
            ...
            <p>
              ...
              are accessing and using the Services on behalf of a company (such
            ...
            <p>
              ...
              through other communications. It’s important that you review the
              ...
              If you don’t agree to be bound by the modified Terms, then you may
              not use the Services anymore. Because our Services are evolving
            ...
            <p>
              ...
              <span className="uppercase">
                ...
                development and are likely to contain defects. a primary purpose
                of granting you access to our Services in this beta-testing
                phase is to obtain feedback on THE services’ performance and the
                identification of defects. we are under no obligation to correct
                or cure defects that have been identified. You are advised to
                safeguard important data, to use caution when using and not to
                rely in any way on the correct functioning or performance of the
                Services. you assume The entire risk arising out of the use of
                the Services.{" "}
              </span>{" "}
            </p>
            ...
            <h2>Eligibility</h2>
            <p>
              You may use the Services only if you are 13 years (16, if you are
              an EU citizen) or older and are not barred from using the Services
              under applicable law.{" "}
            </p>
            <h2>Registration and Your Information</h2>
            <p>
              If you want to use certain features of the Services you’ll have to
              create an account ("<b>Account</b>"). You can do this via the
              Site. You must provide a name, email address, and any other
              information requested in order to complete the signup process and
              register your Account. You’re responsible for all activities that
              occur under your Account, whether or not you know about them.
              (Note: before September 2020, this paragraph was significantly
              more restrictive and we relaxed it to better support student
            ...
            <p>
              ...
              users can create multiple projects ("<b>Project</b>"), each of
              which acts as a file system with multiple directories, inside of
              which a user can create and edit any number of files of any type
              (such as Latex documents, IPython notebooks, and SageMath
              worksheets) as well as write, compile, and run software code in
              various programming languages (such files and code collectively, "
              <b>Files</b>"). You’ll be able to share your Files with other
              users of the Services, as well as enable them to contribute to and
              build upon them and share them as well. When you create Files, you
              can, if you choose, specify the terms and conditions that govern
              other users’ use of your Files (e.g. a specific software or
              creative commons license) ("<b>File License</b>"). Similarly, if
              you download, access or use another user’s Files through the
              Services, you agree that you will use such Files strictly in
              accordance with the File License terms associated with that File
              (if any), as indicated through the Services. If you don’t agree
              with the terms of a File License, then you may not use the
              applicable Files.{" "}
            </p>
            <p>
              ...
              Account holder member of such Collaborator Team to use such Files
              in accordance with the applicable File License you’ve specified
              for such Files through the Services. If you haven’t specified an
              ...
              worldwide, non-transferable, sublicenseable (to other
              Collaborators) license to copy, modify, create derivative works
              based upon, and publicly display, your Files. Each Collaborator
              can make your Files public, by Posting them (as described below).
              Additionally, each Collaborator can elect to share your Files with
              other Account holders. Such additional Account holders will become
              part of the Collaborator Team, and will have the same rights to
              access and use your Files as those granted to Collaborators in
              this paragraph.{" "}
            </p>
            <p>
              ...
              display, your Files; and (b) non-Account holder users of the
              Service a non-exclusive, non-transferable license to view such
              Files.{" "}
              <span className="uppercase">
                Once you POST TO THE GENERAL PUBLIC, you can LATER un-POST, but
                the licenses granted will remain in effect. You cannot revoke
                this license, so we encourage you to consider carefully before
                POSTING.{" "}
              </span>{" "}
            </p>
            <h1>API Terms</h1>
            ...
            <ul>
              <li>
                You expressly understand and agree that SMI shall not be liable
                ...
                (even if SMI has been advised of the possibility of such
                damages), resulting from your use of the API or third-party
            ...
            <p>
              ...
              you upgrade from a free to a paid plan) you must provide SMI with
              complete and accurate billing and contact information. You will be
              billed immediately upon an upgrade from the free plan to any paid
              plan. Paid plans may include free temporary trial periods. For
              paid plans where payment is due on a monthly basis, you will be
              billed for the Services in advance on a monthly non-refundable
              ...
              of all taxes, levies, or duties imposed by taxing authorities, and
              ...
              SMI’s net income. For any upgrade or downgrade in paid plan level
              while on a monthly billing cycle, you will automatically be
              charged the new rate on your next billing cycle. For upgrades or
              downgrades while on a yearly plan, SMI will immediately charge or
              refund the difference in plan cost, prorated for the remaining
              time in your yearly billing cycle. Downgrading your plan may cause
              the loss of access to Content, features, or capacity of your
              Account. SMI does not accept any liability for such loss. We may
              suspend or terminate the Services if fees are 30 days past due.
              You agree to pay, and authorize SMI’s third party payment
              processor to charge using your selected payment method, for all
              applicable fees and taxes that may accrue in relation to your use
              of the Services. The fees for your subscription to use the
              Services are set forth at{" "}
              <A href="/pricing">https://cocalc.com/pricing</A>. Pricing for the
              Services, including but not limited to monthly subscription plan
              fees, are subject to change upon thirty (30) days’ notice from
              SMI. Such notice may be provided at any time by posting the
            ...
            <p>
              ...
              emailing us{" "}
              <A href="mailto:office@sagemath.com">office@sagemath.com</A>. You
            ...
            <p>
              ...
              (ii) "<b>User Content</b>" means any Content that Account holders
              (including you) provide to be made available through the Services
              (including without limitation, Files). Content includes without
            ...
            <p>
              ...
              foregoing, SMI and its licensors exclusively own all right, title
              ...
              Services and Content are protected by copyright, trademark, and
              other laws of the United States and foreign countries. You agree
              not to remove, alter or obscure any copyright, trademark, service
            ...
            <p>
              ...
              Account holders and non-Account holder users of the Services who
              are permitted access to your Files the right to use your Files in
            ...
            <p>
              ...
              nor any use of your User Content by SMI on or through the Services
            ...
            <p>
              ...
              authorize SMI to use and disclose) this data only in aggregate
              form (i.e., data aggregated from various users’ use of the
              Services, but not specifically identifying you).{" "}
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                element within the Services, SMI’s name, any SMI trademark, logo
                or other proprietary information, or the layout and design of
                any page or form contained on a page, without SMI’s express
                written consent;{" "}
              </li>
              <li>
              ...
              <li>
                ...
                software and/or search agents provided by SMI or other generally
            ...
            <p>
              ...
              prosecute users who violate the law. If your bandwidth usage in
              connection with your use of the Services significantly exceeds the
              average bandwidth usage (as determined solely by SMI) of our other
              users, we reserve the right to immediately disable your Account or
              throttle your use of the Services (including without limitation,
            ...
            <p>
              ...
              to you. You may cancel your Account at any time by clicking on the
              Account link in the global navigation bar at the top of the screen
              through which you are accessing the Services. Upon any
              ...
              Ownership and Responsibility (excluding Rights in Content granted
              by SMI); General Prohibitions and SMI’s Enforcement Rights;
              Indemnity; Limitation of Liability; Dispute Resolution; Governing
              Law and Jurisdiction; General Terms.{" "}
            </p>
            ...
            <p className="uppercase">
              ...
              WARRANTY THAT THE SERVICES OR CONTENT WILL MEET YOUR REQUIREMENTS
              OR EXPECTATIONS OR BE AVAILABLE ON AN UNINTERRUPTED, SECURE, OR
              ERROR-FREE BASIS. WE MAKE NO WARRANTY (I) REGARDING THE QUALITY,
              ACCURACY, TIMELINESS, TRUTHFULNESS, COMPLETENESS OR RELIABILITY OF
              THE SERVICES OR ANY CONTENT; OR (II) THAT ANY CONTENT DOWNLOADED
              OR OTHERWISE ACCESSIBLE BY YOU THROUGH THE SERVICES WILL BE FREE
              FROM ANY VIRUSES, TROJAN HORSES, WORMS, OR OTHER COMPUTER
              PROGRAMMING DEVICES WHICH MAY DAMAGE A USER’S COMPUTER, SYSTEM OR
              DATA OR PREVENT THE USER FROM USING ITS COMPUTER, SYSTEM OR DATA.
              YOU KNOWINGLY AND FREELY ASSUME ALL RISK WHEN USING THE SERVICES
              AND THE CONTENT.{" "}
            </p>
            <p className="uppercase">
              ...
              DISCLAIM ALL LIABILITY IN CONNECTION WITH OR ARISING FROM (I) ANY
              ACTS, OMISSIONS OR NEGLIGENCE ON THE PART OF ACCOUNT HOLDERS; (II)
              ACCOUNT HOLDER’S OR NON-ACCOUNT HOLDER USERS’ USE OF THE USER
              CONTENT, INCLUDING NON-COMPLIANCE WITH FILE LICENSES; AND (III)
              ANY LOSS OR DAMAGE CAUSED, INCLUDING, DAMAGES TO PROPERTY, LOSS OF
              SERVICES OR OTHER DAMAGES OR HARM, WHETHER TO YOU OR TO THIRD
              PARTIES, WHICH MAY RESULT FROM YOUR USE OF THE SERVICES AND
              CONTENT. IN THE EVENT OF AN ACCOUNT HOLDERS’ OR NON-ACCOUNT HOLDER
              USERS’ NON-COMPLIANCE WITH YOUR FILE LICENSE, YOU AGREE THAT YOUR
              ONLY RECOURSE IS AGAINST THE APPLICABLE ACCOUNT HOLDER OR
              NON-ACCOUNT HOLDER USER WHO DOWNLOADS THE CONTENT.{" "}
            </p>
            <h1>Indemnity</h1>
            <p>
              ...
              Content, or (iii) your violation of these Terms (including without
              limitation your use of a File other than in accordance with the
              applicable File License and a breach by you of any representations
              or warranties in these Terms).{" "}
            </p>
            ...
            <p className="uppercase">
              ...
              SERVICES ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR FROM
              THE USE OF OR INABILITY TO USE THE SERVICES OR CONTENT, WHETHER
              BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE), PRODUCT
              LIABILITY OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT CLIENT HAS
            ...
            <p className="uppercase">
              ...
              the ServiceS or content EXCEED THE AMOUNTS YOU HAVE PAID TO SMI
              FOR USE OF THE SERVICES OR content OR ONE HUNDRED DOLLARS ($100),
              IF YOU HAVE NOT HAD ANY PAYMENT OBLIGATIONS TO SMI, AS APPLICABLE.{" "}
            </p>
            <p>
            ...
            <p>
              ...
              exclusive jurisdiction and venue of any IP Protection Action will
              be the state and federal courts located in the Northern District
              of California and each of the parties hereto waives any objection
            ...
            <p>
              ...
              calling the AAA at 1-800-778-7879.) The Federal Arbitration Act
            ...
            <p>
              ...
              the extent provided under applicable law. SMI will not seek, and
              hereby waives all rights it may have under applicable law to
            ...
            <p>
              ...
              above, if SMI changes this "Dispute Resolution" section after the
              ...
              us written notice (including by email to www.client.com) within 30
              ...
              agreeing that you will arbitrate any Dispute between you and SMI
              in accordance with the provisions of this "Dispute Resolution"
              section as of the date you first accepted these Terms (or accepted
            ...
            <p>
              ...
              For notices made by e-mail, the date of receipt will be deemed the
            ...
            <p>
              ...
              writing and signed by a duly authorized representative of SMI.
            ...
            <p>
              ...
              or concepts under the terms of the GNU Affero General Public
              License, version 3, as stated at{" "}
