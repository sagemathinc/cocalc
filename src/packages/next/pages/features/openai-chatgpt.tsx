        ...
        <Layout.Content>
            ...
            subtitle={
              <>
                <div>
                  ...
                  language model capable of generating human-like responses to
                  various prompts and queries.
                </div>
              </>
            }
          ...
          >
            <Paragraph>
              ...
              . The prompt is: "multiply two random matrices in pytorch".
            </Paragraph>
            <Paragraph>
              ...
              can immediately play around with it.
            </Paragraph>
            <Paragraph>
              <Image
...
export function ChatGPTFixError({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    ...
    >
      {intro()}
      <Paragraph>
        In this example, a code cell in a Jupyter Notebook returned an error.
        Clicking the botton to explain the error message creates a message
        addressed to ChatGPT, which asks for help and to fix the code.
      </Paragraph>
      <Paragraph>
        With enough context, i.e. the few lines of input code and the lines in
        the stacktrace, it will attempt to fix the code for you. The fix might
        not be perfect, but it can be a good starting point.
      </Paragraph>
    </Info>
  );
}
