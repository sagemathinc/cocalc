...
const PAST_EXPERIENCE: ExperienceComponentProps['experiences'] = [
  {
        ...
        >
          ...
          >
            <Space direction="vertical" size="middle">
              <TitleComponent name="Meet William Stein." level={2}/>
              ...
              <Row wrap gutter={24}>
                <Col xs={24} md={12}>
                  <Card
                    ...
                    cover={<Image
                      src={WilliamSteinImage}
                      alt="William Stein with his dog, Bella."
                    />}
                  >
                    <Card.Meta
                      title="William Stein, CEO & Founder"
                ...
                <Col xs={24} md={12}>
                  ...
                  <Typography.Paragraph>
                    In his role as CEO of SageMath, Inc., William is at the
                    helm, navigating the future of CoCalc. His
                    responsibilities span delegating tasks, driving
                    profitability, and managing the company’s overall growth
                    strategy. In addition, he maintains a close eye on
                    developments within the cloud-based software industry,
                    assesses company risks to ensure they’re minimized, and
                    ensures that CoCalc remains stable and productive.
                  </Typography.Paragraph>
              ...
              <ExperienceComponent experiences={PAST_EXPERIENCE} />
            </Space>
          </div>
          <Footer/>
        </Layout.Content>
