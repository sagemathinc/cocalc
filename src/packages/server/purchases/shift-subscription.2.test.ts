...
//   });
  ...
  it("shifts the subscription to have closing date of 6, then confirms (1) subscription shifted, (2) license was changed, and (3) customer was billed for change", async () => {
    const sub = await getSubscription(subscription_id);
