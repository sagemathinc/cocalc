...
// Returns the number of mounted cloud filesystems in the given project
...
// Attempt to unmount cloud filesystems on the given compute server.
...
// e.g., before suspending since having a cloud filesystem running while
