...
client = await require('@cocalc/backend/conat').conat(); kv = require('@cocalc/backend/conat/sync').dkv({project_id:'3fa218e5-7196-4020-8b30-e2127847cc4f', name:'a.txt', client})
