...
- [ ] The read-file-from-disk content doubling bug is still there. NOT fixed by recent change.  This file: http://localhost:7000/projects/00000000-1000-4000-8000-000000000000/files/build/cocalc-lite/src/packages/sync/editor/generic/sync-doc.ts#line=2037
got doubled.

```
a._syncstring.show_history({trunc:50})
log.ts:30 [44m9s Δ 5.86s - 2025-12-12T17:09:59.368Z] 001 t=1765559138305 v=1 user=1 wall=1765559137510 (patch [[[[1,"/*\n *  This fil...);\n}\n"]],0,0,0,1169]])
log.ts:30 [44m9s Δ 0s - 2025-12-12T17:09:59.368Z]            "/*\n *  This file is part of CoCalc: Copyright © 2024 Sagemath, Inc.\n *  License: MS-RSL – see LICENSE.md for details\n */\n\nimport React, { createContext, useContext, useEffect, useMemo, useState } from \"react\";\nimport type { ImmerDB } from \"@cocalc/sync/editor/immer-db\";\nimport type { Document } from \"@cocalc/sync/editor/generic/types\";\n\ntype DocCtx = {\n  syncdb?: ImmerDB;\n  doc?: Document;\n  version: number;\n};\n\nconst ChatDocContext = createContext<DocCtx>({ version: 0 });\n\nexport function ChatDocProvider({\n  syncdb,\n  children,\n}: {\n  syncdb?: ImmerDB;\n  children: React.ReactNode;\n}) {\n  const [version, setVersion] = useState(0);\n\n  useEffect(() => {\n    if (!syncdb) return;\n    const onChange = () => setVersion((v) => v + 1);\n    syncdb.on(\"change\", onChange);\n    return () => {\n      syncdb.off(\"change\", onChange);\n    };\n  }, [syncdb]);\n\n  const value = useMemo<DocCtx>(\n    () => ({\n      syncdb,\n      doc: syncdb?.get(),\n      version,\n    }),\n    [syncdb, version],\n  );\n\n  return (\n    <ChatDocContext.Provider value={value}>{children}</ChatDocContext.Provider>\n  );\n}\n\nexport function useChatDoc(): DocCtx {\n  return useContext(ChatDocContext);\n}\n"
log.ts:30 [44m9s Δ 0s - 2025-12-12T17:09:59.368Z] 002 t=1765559180298 v=2 user=0 wall=1765559180298 parents=[1765559138305] (patch [[[[1,"/*\n *  This fil...);\n}\n"]],0,0,0,1466]])
...
log.ts:30 [44m9s Δ 0s - 2025-12-12T17:09:59.368Z] 
Current: "/*\n *  This file is par...text(ChatDocContext);\n}"
```
