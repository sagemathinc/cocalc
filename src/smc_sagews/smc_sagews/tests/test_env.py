...
class TestNoStartupFile:
    def test_init_sage(self, exec2, test_ro_data_dir):
        exec2("pi", pattern="pi")
        pssf = os.path.join(test_ro_data_dir, conftest.my_sage_startup())
        pssf2 = os.path.join(test_ro_data_dir, "sage_init_files/define_var.sage")
...
class TestGoodStartupFile:
    ...
    def test_init_sage(self, exec2, test_ro_data_dir):
        ...
        pssf = os.path.join(test_ro_data_dir, conftest.my_sage_startup())
        remove_no_exc(pssf)
        pssf3 = os.path.join(test_ro_data_dir, "sage_init_files/runtime_err.sage")
...
class TestRuntimeErrStartupFile:
    ...
    def test_init_sage(self, exec2, test_ro_data_dir):
        ...
        pssf = os.path.join(test_ro_data_dir, conftest.my_sage_startup())
        remove_no_exc(pssf)
        pssf4 = os.path.join(test_ro_data_dir, "sage_init_files/syntax_err.sage")
