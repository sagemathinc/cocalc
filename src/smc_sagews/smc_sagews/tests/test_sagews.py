...
class TestIntrospect:
    ...
    def test_sage_autocomplete_295_setup(self, exec2):
        exec2("aaa=Rings()._super_categories_for_classes;len(aaa[0].axioms())",
              "6\n")
...
class TestAttach:
    ...
    def test_attach_html_1(self, execblob, test_ro_data_dir):
        ...
        execblob(
            "%attach {}".format(fn),
            want_html=False,
            want_javascript=True,
            file_type='html')

    def test_attach_html_2(self, exec2):
        exec2(
            "paf()",
            pattern="attached files: 3\n.*/a.html\n.*/a.py\n.*/a.sage\n")
