...
def contenttypes():
    ...
    parts = {
        ...
        '/docProps/core.xml':
        'application/vnd.openxmlformats-package.co'
        're-properties+xml',
        '/docProps/app.xml':
        'application/vnd.openxmlformats-officedocu'
...
def picture(relationshiplist,
    ...
    xfrm.append(
        makeelement('off', nsprefix='a', attributes={
            'x': '0',
            'y': '0'
        }))
    xfrm.append(
                            ...
                            if match:
                                ...
                                if DEBUG:
                                    ...
                                    if isinstance(replace, etree._Element):
                                        ...
                                        log.debug(
                                            "Will replace with LIST OF ELEMENTS"
                                        )
                                    else:
                                        log.debug(
                                            "Will replace with:",
                                ...
                                for i in e:
                                    ...
                                    if curlen > match.start() and not replaced:
                                        ...
                                        replaced = True
                                        log.debug("Replacing in element #: %s",
                                                  i)
                                    else:
...
def main():
    try:
        ...
        print(
            '''  example-extracttext.py 'My Office 2007 document.docx' 'outputfile.txt' '''
        )
        exit()
