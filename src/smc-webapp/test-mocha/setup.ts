...
function load_mocha_tests(path: string): void {
  ...
  if (f("frame-editors/markdown-editor/test/basic"))
    require("frame-editors/markdown-editor/test/basic");
  if (f("frame-editors/markdown-editor/test/math"))
    require("frame-editors/markdown-editor/test/math");
  if (f("frame-editors/code-editor/test/basic"))
    require("frame-editors/code-editor/test/basic");
  if (f("frame-editors/code-editor/test/frame"))
    require("frame-editors/code-editor/test/frame");
  if (f("frame-editors/code-editor/test/actions"))
    require("frame-editors/code-editor/test/actions");
  if (f("frame-editors/code-editor/test/format"))
    require("frame-editors/code-editor/test/format");
  if (f("travis")) require("jupyter/test/travis");

  // not working/useful
  //if (f("account/test/preferences"))
  //require("account/test/preferences");
}
