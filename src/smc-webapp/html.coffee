...
html = require('./top_navbar.html') + require('./account.html') + require('./misc_page.html') + require('./alerts.html') + require('./help.html') + require('./console.html') + require('./projects.html') + require('./project.html') + require('./editor.html') + require('./tasks.html') + require('./archive.html') + require('./jupyter.html') + require('./interact.html') + require('./3d.html') + require('./d3.html')
