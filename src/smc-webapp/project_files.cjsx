...
FileListing = rclass
    ...
    render_no_files : ->
        if @props.listing.length is 0
            <NoFiles current_path={@props.current_path} actions={@props.actions} public_view={@props.public_view} file_search={@props.file_search} current_path={@props.current_path}/>
