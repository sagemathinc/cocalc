            ...
            switch error
                ...
                when 'not_running'
                    ...
                    if error == 'no_instance'
                        ...
                        msg = "The host for this project is down, overloaded, or being rebooted."
                        if require('./customize').commercial and not quotas?.member_host
                            msg += "\nFree projects are hosted on potentially massively overloaded preemptible instances, which are rebooted at least once per day and periodically become unavailable.   To increase the robustness of your projects, first please become a paying customer (US $7/month) by entering your credit card in the Billing tab next to account settings, then move your projects to a members only server. \n\n#{error}"
                        e = <ErrorDisplay title="Host down" error={msg} />
                    else
