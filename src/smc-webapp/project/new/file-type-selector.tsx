...
/* react-redux HOOKS VERSION.   This requires the latest version
   of react-redux, which -- just installing it -- breaks the
   share server, making rendering of any document break. See
     https://github.com/sagemathinc/cocalc/issues/4284
   In resolving #4284, one should uncomment this code below and
