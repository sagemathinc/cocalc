...
export class ProjectFilesActionBox extends React.Component<Props, State> {
      ...
      return (
        <div>
          ...
          <Checkbox
            ...
            onChange={e => this.setState({ overwrite_newer: e.target.checked })}
          >
  ...
  render_share() {
    ...
    return (
      <ConfigureShare
        ...
        set_public_path={opts => this.props.actions.set_public_path(path, opts)}
