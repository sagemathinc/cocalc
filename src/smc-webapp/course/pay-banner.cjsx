...
exports.PayBanner = rclass
    ...
    render: ->
        ...
        if @props.tab == 'settings'
            ...
            mesg = <span>Please open the course <a onClick={@show_settings}>Settings tab</a> and select a pay option.</span>

        <Alert bsStyle='warning' style={fontSize:'12pt', color:'#666'}>
