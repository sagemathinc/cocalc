...
import { Fragment, React, ReactDOM, rclass, rtypes } from "../smc-react";
    ...
    render() {
        return (
            <div style={{ textAlign: "center" }}>
                <h1>
                    {render_group(this.props.state.title, this.props.state)}
                </h1>
...
const Macro = rclass({
    ...
    render_subsection() {
        ...
        state.subsection =
            (state.subsection != null ? state.subsection : 0) + 1;
        return (
            <h3
                style={{
                    fontWeight: "bold",
