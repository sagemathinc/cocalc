...
const check_is_immutable = function(props, propName, componentName, location, propFullName) {
    if (componentName == null) { componentName = "ANONYMOUS"; }
...
const allow_isRequired = function(validate) {
    const check_type = function(isRequired, props, propName, componentName, location) {
        if (componentName == null) { componentName = "ANONYMOUS"; }
...
const create_immutable_type_required_chain = function(validate) {
    const check_type = function(immutable_type_name, props, propName, componentName) {
        if (componentName == null) { componentName = "ANONYMOUS"; }
    ...
    const check_immutable_chain = allow_isRequired(check_type.bind(null, undefined));
