...
if (__guard__(typeof process !== 'undefined' && process !== null ? process.env : undefined, x => x.DEVEL) && !__guard__(typeof process !== 'undefined' && process !== null ? process.env : undefined, x1 => x1.SMC_TEST)) {
...
if (__guard__(typeof process !== 'undefined' && process !== null ? process.env : undefined, x2 => x2.SMC_TEST)) {
...
const types = (exports.types = function(target, declaration, identifier) {
    if (identifier == null) { identifier = "check.types"; }
...
exports.defaults = function(obj1, obj2, allow_extra, strict) {
    ...
    for (var prop in obj2) {
        ...
        if (obj1.hasOwnProperty(prop) && (obj1[prop] != null)) {
            ...
            r[prop] = obj1[prop];
        } else if (obj2[prop] != null) {  // only record not undefined properties
...
const required = (exports.required = (exports.defaults.required = "__!!!!!!this is a required property!!!!!!__"));
