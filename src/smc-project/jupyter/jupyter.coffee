...
class Kernel extends EventEmitter
    ...
    _init_usage_monitor: =>
        ...
        locals =
            ...
            thresh     : 0.1   # report any change of at least thresh percent (we always report cpu dropping to 0)
            interval   : 3500  # frequently (~3.5s) should be OK, since it just reads /proc filesystem
