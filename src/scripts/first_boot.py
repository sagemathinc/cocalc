...
if hostname.startswith('devel'):
    ...
    os.system(
        "zpool import -f pool; zfs mount -a; chmod og-r /projects; su - salvus -c 'cd /home/salvus/salvus/salvus/&& . smc-env&& export BUP_POOL=\"pool\"; ./bup_server start'"
    )
    ...
    os.system(
        'echo ""> /home/salvus/salvus/salvus/data/secrets/sendgrid_email_password'
    )

    # setup a fake pem
    os.system(
        "cp /home/salvus/salvus/salvus/data/secrets/sagemath.com/nopassphrase.pem.fake /home/salvus/salvus/salvus/data/secrets/sagemath.com/nopassphrase.pem"
    )
...
if hostname.startswith('compute'):
    ...
    if False:
        ...
        if not os.path.exists("/mnt/home/crontabs/"):
            os.system(
                "mkdir -p /mnt/home/crontabs/; chmod a+rx /mnt/home/; chgrp crontab /mnt/home/crontabs; chmod 1730 /mnt/home/crontabs"
            )
        os.system(
            "cd /var/spool/cron/; rm -rf crontabs; ln -s /mnt/home/crontabs .")
    ...
    os.system(
        "umount /projects; umount /bup/conf; umount /bup/bups; zpool import -f bup; zfs set mountpoint=/projects bup/projects; chmod og-r /projects"
    )
    ...
    os.system(
        "su - salvus -c 'cd /home/salvus/salvus/salvus/&& . smc-env&& ./bup_server start'"
    )
