...
f = () ->
    s=require('bup_server').global_client(database:db, cb:(err,c)->console.log("err=",err);c.migrate_update_recent_loop(limit:12, max_age_h:48, cb:(e)->console.log("DONE",e)))
setTimeout(f, 5000)
