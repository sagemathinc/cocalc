...
$("#salvus-help").top_navbar
    ...
    close   : false
    onshow: () -> misc_page.set_window_title("SageMathCloud - Help")
...
$("#projects").top_navbar
    ...
    icon : 'fa-tasks'
    close   : false
    onshow: () -> misc_page.set_window_title("SageMathCloud - Projects")
...
$("#account").top_navbar
    ...
    close   : false
    icon : 'fa-signin'
    onshow: () -> misc_page.set_window_title("SageMathCloud - Account")
