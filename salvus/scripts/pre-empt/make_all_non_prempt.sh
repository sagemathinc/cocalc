...
gce create_compute_server --machine_type n1-highcpu-16 --address compute5-us 5

gcloud compute instances delete --keep-disks=all --zone us-central1-c  compute6-leveque-us
gce create_compute_server --machine_type n1-standard-16 --address  compute6-leveque-us